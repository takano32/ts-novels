...
　ちなみに「りぼんの明日」のときには書きませんでしたが、この場合の「りぼん」は「Ｒｅ−Ｂｏｒｎ」です。昔、こういう名前の映画があったと思うんですが（新井素子さんのグリーン・レクイエムの映画と似たような感じのパッケージのビデオだったような・・・）、内容は忘れました。でもその時「なるほど！」と思ったのを頂いちゃった訳です（もう十数年前の話だと思う・・・）。
