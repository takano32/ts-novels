...
<input type=hidden name="nj" value="x8SfFTItMN">
<input type=hidden name="res" value="559">
<h4 align=center>▽ 記事番号 559 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:きらいなもの→チェス "><br>
...
&gt; 
&gt; 現在、溜まっている作品を順次掲載中です。
&gt; しばらくお待ちください。</textarea><br>
tag<input type=checkbox name="tag" value="1" checked> 
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード sSo2Iv  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="sSo2Iv"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
