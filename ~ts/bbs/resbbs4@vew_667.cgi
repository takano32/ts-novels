...
<input type=text size=48 name=subject value=RE:梓という名の下に>
</td></tr>
<tr><td align=right>HP:</td><td><input type=text size=48 name=HP value=></td>
</tr></table>
<textarea name=comment rows=4 cols=70></textarea><br>
<input type=hidden name=mother value=663>
<input type=hidden name=ress value=667>
<input type=submit value=梓という名の下にへ返信>
...
<dl>
<input type=checkbox name=delcode value=667>
<font color=#6A5ACD>RE:梓という名の下に</font></a>
<font color=#FFFFFF>
かすが
 さん</font>
 <font size=2>2003年3月12日(水) 9時41分</font>
 <input type=button value=返信 onclick='location.href="resbbs4@vew_667.cgi"'>
</td></tr><tr><td>
<ul><br><font size=3>亀レスですが・・・・・。<br>「僕は凍り付いてしまった」ほどの来客って、ひょっとして真希ちゃん？<br>もしそうなら、話の展開としては早すぎるかな。<br>それにしても、主人公は女であることにまだ開き直れてないようですね。<br>「少年少女」系の話では、女になったことを楽しんでいる主人公の話が多数派の<br>ように思えるので、かえって新鮮に感じました。<br>　もし本当にＴＳが起こり得るなら、このほうが自然なのかも<br>（当人の性格にもよるのでしょうが）<br></font></ul>
</dl>
</td></tr></table><br>
</td></tr></table>
