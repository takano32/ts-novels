...
<input type=hidden name="nj" value="VGDoNovRGn">
...
&gt; すいません。
&gt; テキストファイルのHMTL化
&gt; というのが何かわかりませんが（なにぶん勉強不足で……）
&gt; ご迷惑をおかけしたようですね。</textarea><br>
tag<input type=checkbox name="tag" value="1" checked> 
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード ou8DHl  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="ou8DHl"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
