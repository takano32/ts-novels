...
<input type=hidden name="nj" value="MhXCrqcS61">
<input type=hidden name="res" value="2518">
<h4 align=center>▽ 記事番号 2518 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
...
&gt; 作品についてなんですけど、女性から男性になると言う逆のパターンってありですか？</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード eXF9Qo  <input type=text name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="eXF9Qo"> <input type=hidden name="hrcode2" size=10 value="&#12354;"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
