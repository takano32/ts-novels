...
<input type=hidden name="nj" value="GrL5EltbYM">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:LYCOS50"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 七斬さん
&gt; http://www.lycos.co.jp/50/
&gt; 
&gt; 有名出版社のブランドに混じって紹介されてると、すごいなあって感じがしますが…。
&gt; Ｆ１レースに自家用軽で出場するみたいでなんか…いいのか？
&gt; 
&gt; …しかし、LYCOSではソノラマ文庫よりメジャーってことっすか？
&gt; Yahoo効果ですかね？
&gt; 
&gt; LYCOS50は火曜日更新だそうですので、閲覧はおはやめに</textarea><br>
