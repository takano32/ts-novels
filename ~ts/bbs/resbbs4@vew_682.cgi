...
<input type=text size=48 name=subject value=RE:第二掲示板移行のお知らせ>
</td></tr>
<tr><td align=right>HP:</td><td><input type=text size=48 name=HP value=></td>
</tr></table>
<textarea name=comment rows=4 cols=70></textarea><br>
<input type=hidden name=mother value=682>
<input type=hidden name=ress value=682>
<input type=submit value=第二掲示板移行のお知らせへ返信>
