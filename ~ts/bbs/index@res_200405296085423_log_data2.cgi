...
<input type=hidden name="nj" value="0EDp9qOwHF">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:削除依頼について"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ トラインさん
&gt; ライターマンさんとダブりましたね（苦笑
&gt; ＴＯＰページに削除依頼は～にというように
&gt; ガイドラインを加えたらどうでしょうか。</textarea><br>
