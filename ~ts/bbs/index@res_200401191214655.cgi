...
<input type=hidden name="nj" value="dgF322X6oH">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:大丈夫！"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 思案の六ぽさん
&gt; 妙な？　励まし有難うございます、よしおかさん。
&gt; でも、当面はストーリー道場で披露している作品のけりがついてからと思っているのですが。二方面作戦はちょっと・・・。</textarea><br>
