...
<input type=hidden name="nj" value="eplHKW8LUP">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re3:一部見れない頁が有ります。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ kouさん
&gt; kouです。あんまり表には顔を出しません（汗
&gt; &gt;▼ VXMASさん
&gt; &gt;&gt; ところで表題の件なのですが、[文庫過去目録] の「Page 2」が見れなくなっております。
&gt; えっと、7/23に正しく表示されないことがあったので再生成させました。
&gt; 
&gt; たまに表示されないときがあります。まあ、そのときはご一報を。</textarea><br>
