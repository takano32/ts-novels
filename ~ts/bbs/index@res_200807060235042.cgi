...
<input type=hidden name="nj" value="jIJwK26ZCt">
<input type=hidden name="res" value="2519">
<h4 align=center>▽ 記事番号 2519 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:質問"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 運営委員さん
&gt; ▼ 通りすがりさん
&gt; &gt; adminに送っても返事が頂けなかったのでこちらで質問させて頂きます。
&gt; &gt; 作品についてなんですけど、女性から男性になると言う逆のパターンってありですか？
&gt; 
&gt; 　7/1送信の問い合わせメールのことでしょうか？
&gt; 　運営システムの都合上、問い合わせに関する話し合いには時間がかかります。各委員の忙暇具合によっては、さらに時間がかかったりします。
&gt; 　そのため、三日程度で問い合わせに回答するのはほぼ不可能です。その点ご了承ください。
&gt; 
&gt; 　ご質問については、メールで回答差し上げたとおりです。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード DJ5RSj  <input type=text name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="DJ5RSj"> <input type=hidden name="hrcode2" size=10 value="&#12354;"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
