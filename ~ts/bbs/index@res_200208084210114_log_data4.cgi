...
<input type=hidden name="nj" value="TJQshS0T1p">
...
&gt; RESありがとうございます。
&gt; 
&gt; &gt; その場合は、トップページからでも、入れない場合は、Norton Internet security（を導入している人は）のプライバシー保護、をOFFにすると観覧が可能です。
&gt; 
&gt; OFFにしたら、見ることができました。
&gt; しかし、Norton Internet Security を導入したのは去年の１２月で、その間に
&gt; ダイヤルアップからフレッツＩＳＤＮには変更しましたが、
&gt; 全く問題なく見ることができたのです。
&gt; Norton Internet Security のプライバシー保護はいじっていないので、
&gt; なぜなんでしょうか？
&gt; できれば、OFFにはしたくないのですが…</textarea><br>
