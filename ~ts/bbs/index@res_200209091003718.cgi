...
<input type=hidden name="nj" value="2LtUW40LYr">
...
&gt; &gt;kouさん、管理人さん
&gt; 
&gt; 掲示板作成のメール届きました。僕がリレー小説をやりたいと言い出したために、
&gt; ここまで色々してくださって本当にありがとうございます。
&gt; 実は、またお願いがあるのですけど……さすがにこんなに色々頼んでしまうのは
&gt; 図々しいかもしれないのですけど……掲示板を作成してもらいましたが、
&gt; 何処からもリンクが貼っていないので掲示板でリレー小説募集やネタ合わせをしたくても、
&gt; 参加希望が掲示板までこないと思うんです。ヤフーとか検索で偶然ＢＢＳだけに
&gt; たどり着くということは滅多にないと思います。それなのでお手数かけますが、
&gt; もしできるようでしたら参加者募集のために……トップページでＢＢＳにリンクを
&gt; 貼っていただくと言う事は無理でしょうか？でも僕が言い出しっぺのリレ－小説で
&gt; トップページの幅が狭まってしまうかもしれませんのでさすがにトップページには
&gt; 無理とかのようならば、無理にではなくても結構なのですけど、
&gt; もしできるようであればトップページからリンクをお願いできますでしょうか？
&gt; 
&gt; &gt;皆様へ
&gt; 
&gt; 一応ＵＲＬにリレー小説ＢＢＳのＵＲＬ入れておきました。
&gt; もしこの書き込みをみてリレー小説に参加してくださると言う方は、
&gt; ＵＲＬのリンクから掲示板に書き込んでいただけると嬉しいです。</textarea><br>
...
<TABLE><TR><TD bgcolor=#114422><font size=+1>[176]</font> <font color=#ff0000 size=2><i>New</i></font><font size=4 color=#40c0c0> アクセス感謝なのでつ</font></TD><TD></td></Tr></TABLE>
</td></table>
...
<table border=0 cellpadding=0 cellspacing=0 width=95%><tr><td><table border=0 cellpadding=1 cellspacing=0 width=100%><td>
<TABLE><TR><TD bgcolor=#114422><font size=+1>[175]</font> <font color=#ff0000 size=2><i>New</i></font><font size=4 color=#40c0c0> 確認いたしました</font></TD><TD></td></Tr></TABLE>
</td></table>
<table border=0 cellpadding=1 cellspacing=0 width=100%><td nowrap>
