...
<input type=hidden name="nj" value="60E4GwgMkO">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:お礼と質問"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ starbow@運営委員さん
&gt; yukさん、
&gt; 
&gt; ＞同時投稿は可能なのでしょうか？やはりそれも二重投稿に当たるのでしょうか？
&gt; ＞もしできるなら何個ぐらいなら許容範囲内でしょうか？
&gt; 同時投稿は、二重投稿になります。
&gt; 
&gt; ほかの方の投稿ありますので、一度に複数投稿されても１つしか対応できません。
&gt; ひとつづつとしてください。
&gt; 
...
削除キー <input type=password name="pwd" size=10 value=""> 入力コード IPBWXj  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="IPBWXj"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
