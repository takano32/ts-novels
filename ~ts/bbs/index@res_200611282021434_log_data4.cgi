...
<input type=hidden name="nj" value="F75TVu8SuX">
<input type=hidden name="res" value="529">
<h4 align=center>▽ 記事番号 529 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:ここでいいのかどうか解りませんが…… "><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ starbow@運営委員さん
&gt; yukさん、
&gt; 
&gt; RESが遅く申し訳ありません。
&gt; 
&gt; &gt;ストーリー道場に迷惑なレスが多発しているようです
&gt; 「何シリーズ！！？」にあったものは、削除しておきました。</textarea><br>
tag<input type=checkbox name="tag" value="1" checked> 
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード nHqp3f  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="nHqp3f"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
