...
<input type=hidden name="nj" value="PAtETENg1N">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:そういう場合は"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 赤目さん
&gt; &gt; 作者名で作品検索を行うと、ほとんどの人の場合はその人の書いた全作品が拾えます。
&gt; 
&gt; こちらのサイトさんだけでなく、ボランティアベースで運営されている
&gt; 場所の場合、負荷軽減のためなるべく検索は使わないようにしています。
&gt; でも、今回は使わせて貰いましたが（ｗ</textarea><br>
