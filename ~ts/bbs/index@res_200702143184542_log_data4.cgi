...
<input type=hidden name="nj" value="gx5bfLhDKq">
<input type=hidden name="res" value="564">
<h4 align=center>▽ 記事番号 564 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re3:削除願いです "><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ ぎゃくるとさん
&gt; ▼ starbow@運営委員さん
&gt; 削除の件、どうもありがとう御座いました。
&gt; ところで第二掲示板では、不適切な投稿が多くて困ってしまいますよね。
&gt; それらの投稿を、基の投稿者が削除できるような方法は無いのでしょうか？</textarea><br>
tag<input type=checkbox name="tag" value="1" checked> 
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード UzJFX4  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="UzJFX4"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200703224225121&log=data4">返信</a>　削除<input type=checkbox name="target" value="200703224225121"></font>
</td></table>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200702272013205&log=data4">返信</a>　削除<input type=checkbox name="target" value="200702272013205"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
<font size=3 color=#606060><font color="#cc88ff">>また、第二掲示板の古い作品に大量のスパムが張られております。</font><br>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200702191230856&log=data4">返信</a>　削除<input type=checkbox name="target" value="200702191230856"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200702143184542&log=data4">返信</a>　削除<input type=checkbox name="target" value="200702143184542"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200702132222825&log=data4">返信</a>　削除<input type=checkbox name="target" value="200702132222825"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200702132113526&log=data4">返信</a>　削除<input type=checkbox name="target" value="200702132113526"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200702132101422&log=data4">返信</a>　削除<input type=checkbox name="target" value="200702132101422"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200702132005320&log=data4">返信</a>　削除<input type=checkbox name="target" value="200702132005320"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200702132004924&log=data4">返信</a>　削除<input type=checkbox name="target" value="200702132004924"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200702110161543&log=data4">返信</a>　削除<input type=checkbox name="target" value="200702110161543"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
