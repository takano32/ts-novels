...
<input type=hidden name="nj" value="DFOx2tYo9n">
<input type=hidden name="res" value="289">
<h4 align=center>▽ 記事番号 289 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:(ノ*゜▽゜*)うん"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 電波妖精さん
&gt; いろいろ考えました。
&gt; 結論はやっぱ書きたいときに書く。感想も作品も。
&gt; これに収束していくんでしょうか。
&gt; いろいろと考えた結果なんですけど、これに
&gt; 妥当性何パーセントと答えがあるわけじゃないのがつらいところですけど、
&gt; みなさんのお答えを拝見し、そしてボクなりの結論としては
&gt; こういう答えが出たのです。</textarea><br>
