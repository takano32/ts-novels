...
<input type=hidden name="nj" value="cCX8wZkolg">
<input type=hidden name="res" value="2411">
<h4 align=center>▽ 記事番号 2411 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:背景設定の描き方"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 米津さん
&gt; 例えばこんなものがあります。
&gt; http://www.amazon.co.jp/gp/product/4766111389/249-6751441-5077165?v=glance&amp;n=465392
&gt; 表紙は→http://www.ne.jp/asahi/viewn/net/miyako/news.htm
&gt; 
&gt; これに限らず大型書店に行くとコミック制作用の資料が硬軟織り交ぜて色々ありますが、
&gt; 実際のところ現実よりもコミック文化の中のお約束の資料と捉えた方がよさそうな気がします。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード WBNATC  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="WBNATC"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
