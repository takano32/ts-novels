...
<input type=hidden name="nj" value="ZToSmRyv6k">
...
&gt; &gt;続きです。
&gt; &gt;ちなみに、他のサイトの物語はすべてONでも見られます。
&gt; &gt;このサイトに何か特別な設定があるのでしょうか？
&gt; 　そのことですが、不正アクセスや、作品を一括でダウンロードするロボットが走っていて、おそらく、それが原因で転送量がオーバーしてしまいました。
&gt; 　それで、サーバーを移動して、特殊な設定にしたそうです。　記事番号　25,26を参照して、設定を行ってください</textarea><br>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208084125134&log=data4">返信</a>　削除<input type=checkbox name="target" value="200208084125134"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208084024420&log=data4">返信</a>　削除<input type=checkbox name="target" value="200208084024420"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208084012322&log=data4">返信</a>　削除<input type=checkbox name="target" value="200208084012322"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208084011448&log=data4">返信</a>　削除<input type=checkbox name="target" value="200208084011448"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
