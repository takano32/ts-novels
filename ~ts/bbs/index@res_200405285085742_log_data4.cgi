...
<input type=hidden name="nj" value="AVggavWkBm">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:なるほど"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ kou@運営委員さん
&gt; 　kouです。
&gt; 
&gt; &gt; 第二掲示板にある作品は真っ先に保存！ということですね
&gt; &gt; (移行後の第二掲示板の作品は今のところ１つも消えてませんが）
&gt; 
&gt; 　移行後はログを削除しないように設定しました。さすがに膨大なサイズになったら考えますが、今はそのままで行きます。</textarea><br>
