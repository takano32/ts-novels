...
<input type=hidden name="nj" value="mpeAkCk6sk">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:バックアップファイルを受け取りました"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ トラインさん
&gt; あき_記録魔さんにはメールでも伝えておきましたが、
&gt; ここにも念のため。</textarea><br>
