...
<input type=hidden name="nj" value="SQloABh6Ik">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:ループ＆ループ"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 携帯ユーザーさん
&gt;   長い話を考えています。文章じゃなくて、連載モノとして。文庫でも結構ありますが、どのくらいの長さが理想的でしょうか？</textarea><br>
