...
<input type=hidden name="nj" value="xkeQnFcVrZ">
<input type=hidden name="res" value="560">
<h4 align=center>▽ 記事番号 560 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
...
&gt; そういうことでしたか。
&gt; それなら仕方ありませんね。
&gt; それでは私はおとなしく続きを書いている事にします。</textarea><br>
tag<input type=checkbox name="tag" value="1" checked> 
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード rwCbzc  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="rwCbzc"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
