...
<input type=hidden name="nj" value="zYosY4NZN6">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:タブブラウザ"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ ｍｋ８４２６さん
&gt; ワタクシはMoonBrowser（IEコンポーネントブラウザ）を使ってますが、別段問題はないですよ。
&gt; しかし、他にMoon使ってる人っているのかねぇ（笑）。</textarea><br>
