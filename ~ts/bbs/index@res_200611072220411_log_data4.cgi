...
<input type=hidden name="nj" value="8y95mFwLs4">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:受領メールはいただいたのですが "><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ starbow@運営委員さん
&gt; yukさん、
&gt; 
&gt; 返事が遅くなり、申し訳ありません。
&gt; テキストファイルのHMTL化で手間が掛かっています。今日掲載予定です。
&gt; 宜しくお願いします。</textarea><br>
tag<input type=checkbox name="tag" value="1" checked> 
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード h0HZDf  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="h0HZDf"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
