...
<input type=hidden name="nj" value="SWnYYMCsld">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:感想掲示板"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 米津さん
&gt; 気が付けば全ての作品に作者別の感想掲示板へのリンクが付けられていますね。長年の旧作への感想の問題もこれで解決、今更ですが作業お疲れさまでした。大量の掲示板ができて管理の方は大丈夫でしょうか？
&gt; CGIデータを直接読みとって保管＋表示する感想掲示板ビューアなんてできないものでしょうかね……と考えてみましたが、更新チェックはIf-modified-sinceでできても更新分だけのデータ取得がうまくできないから転送量を考えると厳しいですね……。</textarea><br>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208084232407&log=data2">返信</a>　削除<input type=checkbox name="target" value="200208084232407"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208084200237&log=data2">返信</a>　削除<input type=checkbox name="target" value="200208084200237"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208062225406&log=data2">返信</a>　削除<input type=checkbox name="target" value="200208062225406"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
