...
<input type=hidden name="nj" value="KE7zbMP33C">
<input type=hidden name="res" value="530">
<h4 align=center>▽ 記事番号 530 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
...
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 大原野山城守武里さん
&gt; 一作品におけるファイルの容量若しくは文字数又は行数に限度はあるのでしょうか。</textarea><br>
tag<input type=checkbox name="tag" value="1" checked> 
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード YlGfJ2  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="YlGfJ2"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
