...
<input type=hidden name="nj" value="NEcu3xDRZW">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:一部見れない頁が有ります。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ りょうさん
&gt; ▼ VXMASさん
&gt; &gt; ところで表題の件なのですが、[文庫過去目録] の「Page 2」が見れなくなっております。
&gt; 
&gt; 報告ありがとうございます。
&gt; この件ですが、以前からしばしば発生しているようで、具体的な原因はまだわかっていません。
&gt; ページを更新する際にPage 2のみがうまく生成されないようです。
&gt; 気づいたら修正するようにしてはいるんですが。
&gt; 
&gt; とりあえず直しておきました。</textarea><br>
