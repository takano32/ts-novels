...
<input type=hidden name="nj" value="P9AKVGPooR">
<input type=hidden name="res" value="2540">
<h4 align=center>▽ 記事番号 2540 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:励まし、ありがとうございます"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ NATOさん
&gt; バレットさん、励ましありがとうございます。
&gt; 
&gt; たしかに完結させたい思いはあります。
&gt; 書くとすれば、残り２話（予定）のみです。
&gt; これで感想こなければもう新作を書くことはないでしょう。
&gt; 
&gt; いつになるかわかりませんが、とりあえず９話を投稿するかもしれません。
&gt; 
&gt; 感想・・・・本当にお願いします。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード fpklCf  <input type=text name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="fpklCf"> <input type=hidden name="hrcode2" size=10 value="&#12354;"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
