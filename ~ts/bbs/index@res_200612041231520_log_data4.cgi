...
<input type=hidden name="nj" value="TbRsQCmobu">
<input type=hidden name="res" value="531">
<h4 align=center>▽ 記事番号 531 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
...
&gt; 大原野山城守武里さん、
&gt; 
&gt; &gt;一作品におけるファイルの容量若しくは文字数又は行数に限度はあるのでしょうか。
&gt; 読み手が大容量だと読みにくいため、ファイル容量は、
&gt; ５０ＫＢまでを目安とし、１００ＫＢ程度を上限としてください。
&gt; 
&gt; あくまで目安ですので、作品によって多少のオーバーは許容範囲とします。
&gt; 
&gt; 宜しくお願いします。</textarea><br>
tag<input type=checkbox name="tag" value="1" checked> 
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード lDXO7c  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="lDXO7c"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200612041231520&log=data4">返信</a>　削除<input type=checkbox name="target" value="200612041231520"></font>
</td></table>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200612041002027&log=data4">返信</a>　削除<input type=checkbox name="target" value="200612041002027"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200611282021434&log=data4">返信</a>　削除<input type=checkbox name="target" value="200611282021434"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200611190201453&log=data4">返信</a>　削除<input type=checkbox name="target" value="200611190201453"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200611083001312&log=data4">返信</a>　削除<input type=checkbox name="target" value="200611083001312"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200611072220411&log=data4">返信</a>　削除<input type=checkbox name="target" value="200611072220411"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
<font size=3 color=#606060>yukさん、<br>
<br>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200611050143118&log=data4">返信</a>　削除<input type=checkbox name="target" value="200611050143118"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200610312182939&log=data4">返信</a>　削除<input type=checkbox name="target" value="200610312182939"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200610301223649&log=data4">返信</a>　削除<input type=checkbox name="target" value="200610301223649"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
<font size=3 color=#606060>yukさん、<br>
<br>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200610290163124&log=data4">返信</a>　削除<input type=checkbox name="target" value="200610290163124"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
