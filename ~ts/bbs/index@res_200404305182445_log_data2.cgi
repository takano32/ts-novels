...
<input type=hidden name="nj" value="si7nuYU5fV">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:返信いただきました。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ kou@運営委員さん
&gt; ▼ 十六夜さん
&gt; &gt; ･･･いただいたんですが、あの後どうすればよろしいんでしょうか･･･？
&gt; 　管理用のMLに登録した……そーです。
&gt; 　矢治さんが送ったメールが届いて入ればOKです。</textarea><br>
