...
<input type=hidden name="nj" value="aSXZeceKdX">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:tab browser"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ りょうさん
&gt; ▼ hitoさん
&gt; &gt; タブブラウザでは見えなくなったのかな？
&gt; 
&gt; 不具合の報告は、それが起こった環境を同時に記述すると原因解明の手がかりになります。
&gt; できればそちらの環境を書いていただけるとありがたいのですが。</textarea><br>
