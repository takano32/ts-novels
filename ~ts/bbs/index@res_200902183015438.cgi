...
<input type=hidden name="nj" value="wMrdUbTsUE">
<input type=hidden name="res" value="2535">
<h4 align=center>▽ 記事番号 2535 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:【くろす・あこーど】公式サイト"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 猫野さん
&gt; お待たせしました。【くろす・あこーど】の公式サイトを作りました。
&gt; Ｗｉｋｉ形式ですので、参加者が随時更新できます。
&gt; まだこの公式サイトのように真っ白の、始まったばかりの企画ですが、なにとぞよろしくお願いします。
&gt; 参加ご希望の方は、公式サイト内の掲示板か、作品の感想掲示板にご連絡下さいませ。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード 2m3EFE  <input type=text name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="2m3EFE"> <input type=hidden name="hrcode2" size=10 value="&#12354;"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
