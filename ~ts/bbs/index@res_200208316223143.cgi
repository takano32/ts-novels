...
<input type=hidden name="nj" value="SuYfBmgeuy">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:サーバー"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 八重洲さん
&gt; うちからアクセスするぶんには全然サクサクですよ。
&gt; といってもうちは56Kモデムなんで、あまり違いのわからない環境ですが。</textarea><br>
