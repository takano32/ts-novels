...
<input type=hidden name="nj" value="1HzCjRBP6x">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:にゅ？"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 電波妖精さん
&gt; イラストの描き方のことをおっしゃっているのか。
&gt; それともパソコンに取り込む方法のことをおっしゃっているのか…。
&gt; 
&gt; 前者に対してはとりあえず不断の努力としか言いようがないですね。
&gt; 後者に対しては、とりあえず、スキャナーで取り込むか、タブレットで、カキカキするかぐらいしか知らないです。うーんむ。</textarea><br>
