...
<input type=hidden name="nj" value="K9i7pzFGuL">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:補足"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 原田聖也さん
&gt; あまり考え過ぎず気楽に、自由に描いてくださいね。(^^)</textarea><br>
...
<table border=0 cellpadding=0 cellspacing=0 width=95%><tr><td><table border=0 cellpadding=1 cellspacing=0 width=100%><td>
<TABLE><TR><TD bgcolor=#114422><font size=4 color=#aaaaaa>[247]</font> <font color=#ff0000 size=2><i>New</i></font><font size=4 color=#50d0d0> 服装</font></TD></Tr></TABLE>
</td></table>
<table border=0 cellpadding=1 cellspacing=0 width=100%><td nowrap>
