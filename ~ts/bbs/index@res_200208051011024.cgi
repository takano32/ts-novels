...
<input type=hidden name="nj" value="N33Kcx3Euv">
...
&gt; 　下の一連の発言は二次創作について、抑止の効果を生み出していると思いますので、ちょっとだけ・・・。
&gt; 　『二次創作』については、著作権者がことさら否定していない場合、これは法律的には認められていると思います。そもそも二次創作そのものが、元ネタの宣伝になるのだから、黙示の合意がなされていると解するのが妥当でありましょう。それが表現の自由を保持する上で、大切だからです。
&gt; 　それと、二次創作とまではいえない、いわゆる『一発ネタ』というものに対しては、これは二次創作よりさらに緩やかに解するべきでしょう。『一発ネタ』というものはあるシーンを想起させるという効果をこの場合、指しますが、たとえ、あるシーンがまったく同一であったとしても、そのシーンに至る過程が違うからです。
&gt; 　思いますに、これを認めないのなら、『これがボク？』やら『ない～』やらのシチュは全部不可となってしまいます。一度使われてしまったフレーズを不可とするのは考えてみれば、非常に不合理であるのは自明の理でありませう。
&gt; 　もっとも、これは度が過ぎると、盗作になってしまう可能性があるので、その限界状況を見極めなければなりません。
&gt; 　ところで、そもそも『一発ネタ』というものは、あるシーンの想起によって笑いを取るものであります。とすると、元ネタを書き込むことはその効果を減じることになり、『一発ねた』の性質上、不合理です。ともすれば、『一発ネタ』が原則として認められていることと、その性質から考えて、元ネタを明示しないことにも一定の合理性が認められるように思われます。
&gt; 　以上のことから考えて、二次創作、一発ネタを明示しないことがことさら、法律的に認められていないというわけではないと解します。
&gt; 
&gt; 　ここから、二次創作、一発ネタの元ネタ明示の問題は『法律的』な問題から『倫理的』な問題になりました。
&gt; 　あとは、上記のように、作品の認知度と、作者の裁量にゆだねられるべきでしょう。
&gt; 　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　いじょ♪</textarea><br>
...
<TABLE><TR><TD bgcolor=#114422><font size=+1>[147]</font> <font color=#ff0000 size=2><i>New</i></font><font size=4 color=#40c0c0> 猫野さん＋MONDOさんイラスト</font></TD><TD></td></Tr></TABLE>
</td></table>
<table border=0 cellpadding=1 cellspacing=0 width=100%><td nowrap>
<font size=-1 color=#606060> 2002/08/18 (日) 19:54:43  you' </font></td>
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208180195443">返信</a>　削除<input type=checkbox name="target" value="200208180195443"></font>
</td></table>
...
<table border=0 cellpadding=0 cellspacing=0 width=95%><tr><td><table border=0 cellpadding=1 cellspacing=0 width=100%><td>
<TABLE><TR><TD bgcolor=#114422><font size=+1>[146]</font> <font color=#ff0000 size=2><i>New</i></font><font size=4 color=#40c0c0> Re:猫野さん＋MONDOさんイラスト</font></TD><TD></td></Tr></TABLE>
</td></table>
<table border=0 cellpadding=1 cellspacing=0 width=100%><td nowrap>
<font size=-1 color=#606060> 2002/08/18 (日) 18:40:05  赤目 </font></td>
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208180184005">返信</a>　削除<input type=checkbox name="target" value="200208180184005"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<table border=0 cellpadding=0 cellspacing=0 width=95%><tr><td><table border=0 cellpadding=1 cellspacing=0 width=100%><td>
<TABLE><TR><TD bgcolor=#114422><font size=+1>[145]</font> <font color=#ff0000 size=2><i>New</i></font><font size=4 color=#40c0c0> 猫野さん＋MONDOさんイラスト</font></TD><TD></td></Tr></TABLE>
</td></table>
<table border=0 cellpadding=1 cellspacing=0 width=100%><td nowrap>
<font size=-1 color=#606060> 2002/08/17 (土) 20:26:28  <a href="mailto:vyx02541@nifty.com">TOM</a> </font></td>
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208176202628">返信</a>　削除<input type=checkbox name="target" value="200208176202628"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208154124647">返信</a>　削除<input type=checkbox name="target" value="200208154124647"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208154123256">返信</a>　削除<input type=checkbox name="target" value="200208154123256"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208154105127">返信</a>　削除<input type=checkbox name="target" value="200208154105127"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208154024833">返信</a>　削除<input type=checkbox name="target" value="200208154024833"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208143185927">返信</a>　削除<input type=checkbox name="target" value="200208143185927"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208143165048">返信</a>　削除<input type=checkbox name="target" value="200208143165048"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200208143024823">返信</a>　削除<input type=checkbox name="target" value="200208143024823"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
