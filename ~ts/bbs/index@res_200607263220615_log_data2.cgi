...
<input type=hidden name="nj" value="GCsSCL3NRy">
...
&gt; コードに対応してくる様子を見る限り、手打ちでSPAMをしてる困った業者もいるみたいですね。
&gt; 某掲示板で、SPAMのURLを含む投稿にはiframeでそのURLを100回開くhtmlを返すという対抗案がありました。
&gt; スパム専用ツールには効果がないけど、ああいう業者には効くかもしれません。
&gt; SPAMは遮断できて、SPAMMERはページビューが増えてどっちも幸せ(笑)。
&gt; 
&gt; #いや、まあ、もちろんまずいんですけどね。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード GR0sXY  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="GR0sXY"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200607263220615&log=data2">返信</a>　削除<input type=checkbox name="target" value="200607263220615"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200607252215522&log=data2">返信</a>　削除<input type=checkbox name="target" value="200607252215522"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200607241225040&log=data2">返信</a>　削除<input type=checkbox name="target" value="200607241225040"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200607241224842&log=data2">返信</a>　削除<input type=checkbox name="target" value="200607241224842"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
