...
<input type=hidden name="nj" value="2VXuUXg8tE">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:NG例"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 赤目さん
&gt; このレベルでＮＧですか。
&gt; 自分なんか一杯やってしまってそうです……。
&gt; 
&gt; 難しいですね、最終的には好みの問題も入ってきますし。
&gt; 
&gt; 敢えて他の直し方を考えてみると、逆に最後の部分も克美の視点で書き直
&gt; して統一するという方法もありそうですが。これも、前後の繋がりで変わっ
&gt; てくるでしょうし。
&gt; 
&gt; （というか、このシリーズに続編もあったとは（←などと大ボケ発言
&gt; をｗ）　作者別インデックスから、１だけを拝読していました）</textarea><br>
