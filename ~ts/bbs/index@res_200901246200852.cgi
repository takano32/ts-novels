...
<input type=hidden name="nj" value="HGow1Pwe95">
<input type=hidden name="res" value="2533">
<h4 align=center>▽ 記事番号 2533 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:【くろす・あこーど】補足"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 猫野さん
&gt; 　こんばんは、ごぶさたしております、猫野丸太丸と申します。
&gt; 　以下の設定でおもちばこさんが始めるリレー小説に、私も参加しております。けっこう正統派の学園ＴＳものが描けるんじゃないかなと期待しています。
&gt; 　近日第１話が文庫に（問題なければ）掲載されますので、まずはそれをご覧になって下さい。参加者はひとりづつ、続きを書いていくことになります。
&gt; 　参加の場合の連絡先（外部掲示板）は、第１話掲載ごろには作成できると思います。
&gt; 
&gt; 　それではよろしくお願いいたします。この場をお騒がせしてすみませんでした。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード vPseo9  <input type=text name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="vPseo9"> <input type=hidden name="hrcode2" size=10 value="&#12354;"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
