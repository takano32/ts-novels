...
<input type=text size=48 name=subject value=RE:こんなん書いてみたり。>
</td></tr>
<tr><td align=right>HP:</td><td><input type=text size=48 name=HP value=></td>
</tr></table>
<textarea name=comment rows=4 cols=70></textarea><br>
<input type=hidden name=mother value=668>
<input type=hidden name=ress value=670>
<input type=submit value=こんなん書いてみたり。へ返信>
...
<dl>
<input type=checkbox name=delcode value=670>
<font color=#6A5ACD>RE:こんなん書いてみたり。</font></a>
<font color=#FFFFFF>
電波妖精
 さん</font>
 <font size=2>2003年3月30日(日) 22時12分</font>
 <input type=button value=返信 onclick='location.href="resbbs4@vew_670.cgi"'>
</td></tr><tr><td>
<ul><br><font size=3>ヤヌスの鏡…聞いたことすらないです。<br>ちなみになぜそっちのが萌えるのかというと、それがＴＳ少女萌えなんじゃ…とか言ってみたり。違うかな？</font></ul>
</dl>
</td></tr></table><br>
</td></tr></table>
