...
<input type=hidden name="nj" value="29wMspqqjg">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:第2掲示板ですが"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ ひのひとさん
&gt; 「作品集その8」から現行のページとの間のログが無いように思います。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード aPWk5T  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="aPWk5T"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
