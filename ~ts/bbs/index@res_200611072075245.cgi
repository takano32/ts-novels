...
<input type=hidden name="nj" value="FaebpffT9M">
<input type=hidden name="res" value="2433">
<h4 align=center>▽ 記事番号 2433 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:国会（違）で予算案が通るかどうか、それが問題だ"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 某監査さん
&gt; OFF会、顔出したいんですけど、大阪行って来たばっかりで財布がダイエットしちゃってるんで、保留にします。
&gt; 気持ち的にはだいぶ『参加』のほうに傾いてはいるんですけどねぇ……</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード ONZMuw  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="ONZMuw"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
