...
<input type=hidden name="nj" value="rGdZebjGSL">
<input type=hidden name="res" value="1901">
<h4 align=center>▽ 記事番号 1901 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:イベント「Ｔ's☆Ｈｅａｒｔ」開催のお知らせ"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 米津さん
&gt; 力の入った企画ですねえ。
&gt; ヒロインメーカーには可能性を感じるぞと色々遊んでました。
&gt; 投稿小説に汎用で使えるようにして、もし追加パーツや服を作る人も現れたら……とか。
&gt; で、まあなんとなく、設定を見ながら純女のトラブルメーカーで、メガネで、不敵で、腹に一物ありそうで、
&gt; とか試しに組み合わせてみたら猫野さんとこの井黒さんとまったくダブるキャラになっていましたとさ（笑）</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード hDIzds  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="hDIzds"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
