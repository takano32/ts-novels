...
<input type=text size=48 name=subject value=RE:なんとな〜く思いついた話。>
</td></tr>
<tr><td align=right>HP:</td><td><input type=text size=48 name=HP value=></td>
</tr></table>
<textarea name=comment rows=4 cols=70></textarea><br>
<input type=hidden name=mother value=658>
<input type=hidden name=ress value=658>
<input type=submit value=なんとな〜く思いついた話。へ返信>
