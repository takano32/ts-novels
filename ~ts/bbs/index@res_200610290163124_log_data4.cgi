...
<input type=hidden name="nj" value="uZcC2QJmUs">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:お礼と質問"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ yukさん
&gt; お返事ありがとうございました。受領メールいただきました。
&gt; 
&gt; 再びの質問です。同時投稿は可能なのでしょうか？やはりそれも二重投稿に当たるのでしょうか？もしできるなら何個ぐらいなら許容範囲内でしょうか？何度もすいませんがおへんじよろしくお願いします</textarea><br>
tag<input type=checkbox name="tag" value="1" checked> 
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード HMz5WX  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="HMz5WX"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
