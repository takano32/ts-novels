...
<input type=hidden name="nj" value="OgH3SBROOA">
<input type=hidden name="res" value="2410">
<h4 align=center>▽ 記事番号 2410 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
...
&gt; 情報＆ご教授ありがとうございます。
&gt; 
&gt; &gt; そのままずばりのものは見つかりませんでした。
&gt; そうですか。残念です。
&gt; 
&gt; まあ、今回は初描写というのもあり、あまり懲りすぎて変になるよりはましなので『ありきたり』で行く事にします。
&gt; 元々ゲームに出てくる女の子の部屋のイメージってのもありましたし、今のところそれで充分な気がしますｗ
&gt; 
&gt; ご教授された事は次回、本格的に書くことがあれば参考にさせて頂きます♪。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード NmxoCV  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="NmxoCV"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
