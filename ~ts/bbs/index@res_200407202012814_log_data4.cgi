...
<input type=hidden name="nj" value="vfUJm4bY9f">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:私の杜撰なバックアップでよろしければどうぞ"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ あき_記録魔さん
&gt; 私もちょっと検索してみました。
&gt; ちょうどこのころこのサイトにたどり着いていて、ダイヤルアップユーザーで初めてwebに来たころでした。懐かしいです。
&gt; しかしひたすらこのbbsは重かった。完全に表示されるまでに2分ぐらいかかったいたような気がします。
&gt; 
&gt; ■再中学一年生
&gt; 「再中学一年生」は始めは「新しい自分」ってタイトルだったんですね。でも私も1～3話の投稿時の記録は持ってませんでした。でも、一応tsnovel.jpドメインに移ってるんですね、良かった。
&gt; http://ts.novels.jp/novel/200108/21014120/sai.html
&gt; 
&gt; 再中学一年生第11～14話ですが、
&gt; http://web.archive.org/
&gt; で検索掛けましたが、古いのは&quot;Jun 06, 2002&quot;のレコードしか残っておらず、最古のは15話しか採掘できませんでした。
&gt; 
&gt; 私の持っているファイルでは
&gt; 3・4・5・6・7・8・11
&gt; (なぜか9・10が飛ばされている。ロスト？同じファイルの中なのに？)
&gt; 12・13/* 以降はは現存のログと同じ */
&gt; 
&gt; ■第二の性
&gt; 優さんの作品ですよね？
&gt; え～っと、たまに無題になっていて第x話とかになっていたお話ですよね？
&gt; 現存ファイルを確認しましたところ
&gt; 第1章1～5話
&gt; 第2章1～10話
&gt; 6話?
&gt; 以上のお話がHDに残されていることが確認できました。
&gt; 4年前のファイルですので、3*2+2=8のメディアに分散されて保存されているので、
&gt; 実家と下宿先が同時に地震などで合わない限り大丈夫でしょう。
&gt; メールを頂きましたら、該当ファイル(まとめてなくて重複データが多々ありますが)をお送りいたしますが？どうしますか？&gt;トラインさん</textarea><br>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200408010220821&log=data4">返信</a>　削除<input type=checkbox name="target" value="200408010220821"></font>
</td></table>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200407246222703&log=data4">返信</a>　削除<input type=checkbox name="target" value="200407246222703"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200407202012814&log=data4">返信</a>　削除<input type=checkbox name="target" value="200407202012814"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200407073155402&log=data4">返信</a>　削除<input type=checkbox name="target" value="200407073155402"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200407051211334&log=data4">返信</a>　削除<input type=checkbox name="target" value="200407051211334"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200407051003120&log=data4">返信</a>　削除<input type=checkbox name="target" value="200407051003120"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="index.cgi?res=200407025110126&log=data4">返信</a>　削除<input type=checkbox name="target" value="200407025110126"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
