...
<input type=hidden name="nj" value="iSOptNEVNn">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:そういう場合は"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 矢治 浩平さん
&gt; ＞（というか、このシリーズに続編もあったとは（←などと大ボケ発言
&gt; ＞をｗ）　作者別インデックスから、１だけを拝読していました）
&gt; 
&gt; 作者名で作品検索を行うと、ほとんどの人の場合はその人の書いた全作品が拾えます。</textarea><br>
