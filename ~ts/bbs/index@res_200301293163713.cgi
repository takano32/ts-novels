...
<input type=hidden name="nj" value="EMxiAA7JAK">
<input type=hidden name="res" value="286">
<h4 align=center>▽ 記事番号 286 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:作品も感想も"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ ｍｋ８４２６さん
&gt; とにかく書く。書いて書いて書きまくる。
&gt; 最初の一歩を踏み出すのは勇気がいるかもしれないけれど、そんなに思い詰めなくても。
&gt; とにかく自分がその作品を読んで思ったことを作者に伝えようという気持ちがあれば大丈夫。
&gt; 最初はひとことだけでもいいじゃない。
&gt; そして、その感想がなにか波紋を巻き起こしたら、また、誤解を生んだら、その時は素直に謝ってフォローするなり、誤解を解く努力をするなりすれば済むこと。
&gt; あんまり深刻に考えることはないと思うよ。
&gt; 
&gt; とりあえず感想にレスが付くだけでも嬉しいｍｋ８４２６でした。</textarea><br>
