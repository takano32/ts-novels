...
<input type=text size=48 name=subject value=RE:ノイン・ノエイン　１−A>
</td></tr>
<tr><td align=right>HP:</td><td><input type=text size=48 name=HP value=></td>
</tr></table>
<textarea name=comment rows=4 cols=70></textarea><br>
<input type=hidden name=mother value=644>
<input type=hidden name=ress value=646>
<input type=submit value=ノイン・ノエイン　１−Aへ返信>
...
<dl>
<input type=checkbox name=delcode value=646>
<font color=#6A5ACD>RE:ノイン・ノエイン　１−A</font></a>
<font color=#FFFFFF>
電波妖精
 さん</font>
 <font size=2>2002年10月22日(火) 8時6分</font>
 <input type=button value=返信 onclick='location.href="resbbs4@vew_646.cgi"'>
</td></tr><tr><td>
<ul><br><font size=3>はい。がんばります。ここと某所と某所で展開している話が一つでも<br>終ったら、書こうかなと…。<br>ちなみにTSにしては萌えない性格だなぁと思いつつ書いております。</font></ul>
</dl>
</td></tr></table><br>
</td></tr></table>
