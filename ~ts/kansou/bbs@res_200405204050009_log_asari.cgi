...
<input type=hidden name="nj" value="XvFUk05tZw">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:「友人」感想。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ とある読者。さん
&gt; 　男女比率が偏ったから性転換を促す、という設定はすごく面白いですね。現実的に色々考えさせてもらいました。
&gt; 
&gt; ・各年齢ごとの具体的比率はどうなのか。（大雑把なところ、1/5だけの移行で間に合うとすれば、主人公たちの世代はおおよそこんな感じなのでしょうか？　「５：３→４：４」、または、「２５：１１→５：４」）
&gt; ・比率が偏ることによって人間の育ち方や考え方に影響は出ていないのか。
&gt; ・薬を使う上での制約はあるのか。
&gt; ・制約がなければ強制を急ぐ理由はほとんどないのではないか。
&gt; ・自発的性転換に対する社会的認識はどうなっているのか。
&gt; ・強制ということに対する社会の反応はどうなのか（強制女性化は女性の同性愛者や性同一性障害を大量生産するだけではないのかとか言われそう）。
&gt; ・そもそもなのために女性化するのか（ここでも、女は子供を産む道具じゃないとか言われそう）。
&gt; ・比率偏り判明＆薬の人体使用のメドがたった時点からの啓蒙活動はどう進められたのか。
&gt; ・肉体の女性化の強制だけではなく「女性はこうあるべき」の強制はまた別の問題が生じるのではないか。
&gt; ・高校は任意で通う物だから、その中での選抜は問題があるのではないか。
&gt; ・etcetc...
&gt; 
&gt; 　これはけちをつけてたり不満というわけではなく、書かれていない部分を色々想像して純粋に楽しませてもらっている部分です。
&gt; 　今回は過渡期のシーンですが、三十年も経つと性転換が当たり前になるかもしれない設定ですよね。性転換を広く世間に一般化した世界とかになりそうなので、それも見てみたい気もします。性転換を個人の自由で行なえる世界とか。回数に制限がないなら、第一の性は出産時の性、第二の性は新生児期の両親が決定する性、第三以降の性は自分で決定する性……。なんて考えたりしてしまいました。
&gt; 
&gt; 　長文失礼しました。</textarea><br>
