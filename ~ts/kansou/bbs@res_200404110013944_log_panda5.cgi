...
<input type=hidden name="nj" value="zvwlEeEu9m">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:らむね2/１"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ パンダ５さん
&gt; 自サイトにソーダのテーマ曲（歌詞のみ）があるのでそれもよければ見に来てください。
&gt; あと、自分のサイトに置いてあるらむね２/１小説にはこあみんさんからもらったソーダのイラストが挿絵として入っているので、それもよかったら・・・。</textarea><br>
