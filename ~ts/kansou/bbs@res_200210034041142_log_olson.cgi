...
<input type=hidden name="nj" value="99mRiyoxFX">
...
&gt; なるほど、ペットボトルをらっぱ飲みするとそう映りますわなあ。
&gt; それに吸血行為って、さいこーにエロチックなスキンシップなわけだし。
&gt; 
&gt; &gt; しっかし、名前を考えるセンスがないんだよなぁ
&gt; 
&gt; とおっしゃいますが、名前のヴァリエーションの多寡ってのはそっくりそのまま
&gt; 借り物の名前用の引き出しがいっぱいあるかどうかなのではないでしょうか。
&gt; というわけで、そんなのもっともっといろんな作品に触れれば解消するのでは。
&gt; 
&gt; それがまどろっこしいなら、「女の子の名前辞書」計画
&gt; http://www.dd.iij4u.or.jp/~ume20/f_name/
&gt; を利用するだけ利用するとか。</textarea><br>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200210163203750&log=olson">返信</a>　削除<input type=checkbox name="target" value="200210163203750"></font>
</td></table>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200210126123830&log=olson">返信</a>　削除<input type=checkbox name="target" value="200210126123830"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200210115034408&log=olson">返信</a>　削除<input type=checkbox name="target" value="200210115034408"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200210060221900&log=olson">返信</a>　削除<input type=checkbox name="target" value="200210060221900"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200210056195609&log=olson">返信</a>　削除<input type=checkbox name="target" value="200210056195609"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200210045224023&log=olson">返信</a>　削除<input type=checkbox name="target" value="200210045224023"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200210045014406&log=olson">返信</a>　削除<input type=checkbox name="target" value="200210045014406"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200210034231628&log=olson">返信</a>　削除<input type=checkbox name="target" value="200210034231628"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200210034231300&log=olson">返信</a>　削除<input type=checkbox name="target" value="200210034231300"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200210034045932&log=olson">返信</a>　削除<input type=checkbox name="target" value="200210034045932"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td align=center nowrap><strong><font size=+1>[<a href="bbs.cgi?log=olson">更新</a>] [<a href="http://ts.novels.jp/">終了</a>]</font></strong></td>
</tr></table><p>
<table border=0 cellpadding=4 cellspacing=0><td>
