...
<input type=hidden name="nj" value="tqFmO88BV6">
...
削除キー <input type=password name="pwd" size=10 value=""> 入力コード 3FZ9gs  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="3FZ9gs"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
