...
<input type=hidden name="nj" value="rzEXscOYSs">
...
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 望希さん
&gt; 自分の名前を検索したら｢夢の続き」が出てきました。
&gt; 胸にじーんと来るお話でとてもよかったです。
&gt; また、読みにきます。</textarea><br>
