...
<input type=hidden name="nj" value="6bmeAs4SEh">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:読んでたバイ♪"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 運営委員さん
&gt; &gt; ところで・・・目録、「ジャンル」「種別」「キーワード」が空欄なんですが・・・。
&gt; いや、聞いても返事が来なかったんですね（うちのメールサーバーが潰れていたかもしれない）。
&gt; もう一度送信してみます（汗）</textarea><br>
