...
<input type=hidden name="nj" value="fO2vOZTqO7">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:＞『FMS：pattern P&amp;R』"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ Ｊ・Ｆさん
&gt; やっちまいました。
&gt; 両方別タブで開いておいて、Ｒの方から読んでしまうというポカミスを＿|￣|○
&gt; 
&gt; 教訓：使用上の注意をよく読んでから読みましょう（あれ？）
&gt; 
&gt; というわけで、Ｒメインの感想となりますが。
&gt; 説明が細かく、随分とリアル指向だな、というのが第一印象でした。
&gt; 実際にそういう現象を想像すると、ホラーとはちょっと違う意味で恐くなるというか。
&gt; 
&gt; Ｐサイドは、ひとつひとつの現象と描写がすでにネタバレ状態だったために
&gt; 新鮮さというかホラー的な要素はあまり感じられず、むしろ事例のひとつという印象でした。
&gt; なんでＲから読んじまったかなぁ（爆）
&gt; 
&gt; そういや、Ｒにあった年齢についての説明がＰでは未消化ですね。これがまた新しいネタになるのかも？</textarea><br>
