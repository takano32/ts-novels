...
<input type=hidden name="nj" value="tkLm6iPY6j">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:話の進め方は上手いと思いました"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 死郎さん
&gt; 　ですが……えー。
&gt; 　誤字とか表現の間違いとかを指摘したり、その他辛口の批評はないほうが良いですか？
&gt; 　いろいろ気になる性分なもので。そういうのは嫌な気分になると仰るのであれば、このま
&gt; ま退散します。失礼。</textarea><br>
