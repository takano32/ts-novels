...
<input type=hidden name="nj" value="3BVibzVctj">
<input type=hidden name="res" value="1710">
<h4 align=center>▽ 記事番号 1710 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:「す」"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ この市場さん
&gt; 考え始めると意外に悩むので、素直に後ろから二番目で。
&gt; 
&gt; 「すかあとは　すうすうするし　はずかしい」（スカートは　スースーするし　恥ずかしい）</textarea><br>
