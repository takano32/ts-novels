...
<input type=hidden name="nj" value="1lq8vCWYhF">
...
&gt; 何か好からぬ企みが進行している感じで、ええ感じですなぁ（何）。
&gt; こうなってくると、残る一名（え？）の動向が気になってくるような・・・。
&gt; 元ネタを見ていたわけではないのですが、この作品はそういう条件の元で読んでも楽しめていますよ。
&gt; しかし、○エプロン・・・（笑）。男の夢ですなぁ（爆）。</textarea><br>
