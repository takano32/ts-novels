...
<input type=hidden name="nj" value="Z6DjjPupEo">
...
&gt; ニルゼンさん、大変だったみたいですよ。
&gt; 同情してあげましょうよ。(笑)
&gt; さすがにエンディングが近付いてきたので、伏線張りまくりです。
&gt; 張った伏線をどこまで使いきってしまうかは・・・
&gt; 続編を書くかどうか次第です。
&gt; 
&gt; ＞Ｊ・Ｆさま
&gt; 三連休のおかげで、ちょっと早めの「週刊新米皇女」でした。
&gt; 今回は、ファナールの主力兵器(笑)が炸裂するところが見所でしょう。
&gt; 魔法より威力ありますよね。時によっては。
&gt; 
&gt; ＞電波妖精さま
&gt; 冒頭シーン、もっとアブナイ方向で書きこむべきだったでしょうか？
&gt; 18禁直前ぐらいまで。(笑)
&gt; 
&gt; ＞ｍｋ８４２６さま
&gt; ハッタリはファナールの最大の武器です。(笑)
&gt; 先代の水の女神様については、
&gt; いつか「新米女神の大冒険」を書くことが出来たなら・・・
&gt; 
&gt; ＞あいさま
&gt; ムボービは無敵ですね。(笑)
&gt; クオンがどうしてあんなに無防備なのか・・・
&gt; いちおう理由はあるんですけど。</textarea><br>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200305036230514&log=konoichiba">返信</a>　削除<input type=checkbox name="target" value="200305036230514"></font>
</td></table>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200305036223506&log=konoichiba">返信</a>　削除<input type=checkbox name="target" value="200305036223506"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200305014211909&log=konoichiba">返信</a>　削除<input type=checkbox name="target" value="200305014211909"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200304303200716&log=konoichiba">返信</a>　削除<input type=checkbox name="target" value="200304303200716"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200304281222251&log=konoichiba">返信</a>　削除<input type=checkbox name="target" value="200304281222251"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200304281013033&log=konoichiba">返信</a>　削除<input type=checkbox name="target" value="200304281013033"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200304270030835&log=konoichiba">返信</a>　削除<input type=checkbox name="target" value="200304270030835"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200304270012400&log=konoichiba">返信</a>　削除<input type=checkbox name="target" value="200304270012400"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200304266125322&log=konoichiba">返信</a>　削除<input type=checkbox name="target" value="200304266125322"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200304255202001&log=konoichiba">返信</a>　削除<input type=checkbox name="target" value="200304255202001"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
