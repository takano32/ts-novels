...
<input type=hidden name="nj" value="aPIG0Iz5zD">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:『FMS：pattern K』を見るには下のリンクをクリック。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 運営委員さん
&gt; 【推薦文】彼にとってはどちらも災いでしかなかったような。</textarea><br>
