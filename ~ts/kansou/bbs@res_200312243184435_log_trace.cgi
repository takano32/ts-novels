...
<input type=hidden name="nj" value="9YgN9emYmW">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:再来・この場を借りて"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ TRACE900番台さん
&gt; どうも。掲示板に再び襲来のTRACE900番台だわさ。
&gt; 
&gt; ▽ 本条さま
&gt; &gt;あと、北海道を感じさせるネーミングにも一人で受けてました（笑
&gt; &gt;今後の新キャラの名前にも期待してます～。琴似さんとか星置さんとか（爆
&gt; 個人的にも「後志　苗穂」はお気に入りです。イカめし弁当の森警部も（爆）
&gt; 続編が出るとしたら色男の「薄野（すすきの）くん」なんか出したいんですが（笑）
&gt; 
&gt; ▽ ＭＯＮＤＯさま
&gt; &gt;「ＧＥＮＴＬＥＧＩＲＬ」とも何やらシンクロしてるみたいで、思わずニヤリ。
&gt; 気付いてくれる人がいたとはっ！うるうる（謎）そうです。GENTLEGIRLとは完全に同一の時間の話なのです。
&gt; ……でも、よくよく考えたらウルトラセブンには時間制限無いんですよねぇ（泣）
&gt; 
&gt; ▽ Kardyさま
&gt; &gt;とりあえず、森警部のセリフに爆笑。
...
&gt; う～ん、多分そうでしょう（苦笑）
&gt; 森警部はとある警部補のキャラをそのまま使っています。多分、元ネタになったお方もそうかと。
&gt; ＞キロ28‐2833
&gt; &gt;随分年代ものの天使ですな。
&gt; &gt;2000番台ってのは…寒冷地改造済の証ですか？
&gt; いやはや、寒冷地仕様の2000番台だったとは単なる偶然でした。
&gt; 
&gt; 何はともあれ、皆さまありがとうございます。
&gt; しかし次の投稿はいつになるのやら……</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312232164643&log=trace">返信</a>　削除<input type=checkbox name="target" value="200312232164643"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312232122233&log=trace">返信</a>　削除<input type=checkbox name="target" value="200312232122233"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312232113222&log=trace">返信</a>　削除<input type=checkbox name="target" value="200312232113222"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312232094729&log=trace">返信</a>　削除<input type=checkbox name="target" value="200312232094729"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312232075541&log=trace">返信</a>　削除<input type=checkbox name="target" value="200312232075541"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
