...
<input type=hidden name="nj" value="izlpwB4x8F">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:ざっと、「美少年も・・・」読みました"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ eeeeeさん
&gt; まあ、嫌いじゃない設定。気になるのは、まず余分な『、』の出現、『、，』の混在、『。」』。それに、ヒロインさやかの名前が３種類出てきたこと。
&gt; 小説としては、もっと筆力（表現力）を磨かないと…。日本語として、その使い方はおかしいという箇所は他の作家に比べれば少ないが、同じ書き出しの行が並ぶとか、同じ表現が続くとか。それに、小説としての面白さという点で、もっと書くべきことが抜けていてるように思う。他には、『男として…』とかの一般論の部分は、違和感がある。（内容ではなくてその表現に。視点移動しない別の形に）</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200401040183955&log=kotobuki_hikaru_ndcss">返信</a>　削除<input type=checkbox name="target" value="200401040183955"></font>
</td></table>
...
<td align=center nowrap><strong><font size=+1>[<a href="bbs.cgi?log=kotobuki_hikaru_ndcss">更新</a>] [<a href="http://ts.novels.jp/library.html">終了</a>]</font></strong></td>
</tr></table><p>
<table border=0 cellpadding=4 cellspacing=0><td>
