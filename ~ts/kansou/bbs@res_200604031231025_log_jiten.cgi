...
<input type=hidden name="nj" value="DzSXeWmz1s">
<input type=hidden name="res" value="1903">
<h4 align=center>▽ 記事番号 1903 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:ここまで考えています。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ ＭＯＮＤＯさん
&gt; 多人数参加型掲示板リレー小説「Ｔ'ｓＨｅａｒｔ（仮）」
&gt; 
&gt; １．イベントの主旨
&gt; 　架空の中高一貫校を舞台とした、ＴＳっ娘たちの日常（？）とふれあいを描いたリレー小説。
&gt; 　舞台は現在（極近未来）。どこにでもあるような普通の私立校。
&gt; 　ただしどういうわけか、女子生徒の中に何人もＴＳっ娘が混じっていたりする……
&gt; 
&gt; ２．イベントの概要
&gt; 　参加者（以下プレイヤー）が設定したキャラクター（プレイヤーキャラクター、以下ＰＣ）と、あらかじめ話し合って設定しておいた共通使用キャラクター（ノンプレイヤーキャラクター、以下ＮＰＣ）のやりとりを小説や会話文等で描写し、物語を展開していく。
&gt; 　イベント開始当初に設定したＮＰＣ（以下、メインＮＰＣ）が一応の「主人公」ということになるが、主観はＰＣ側でもＮＰＣ側でもＯＫ。一人称、三人称も問わない。
&gt; 　もちろん展開に応じてＰＣ同士だけで物語を進めたり、脇役としてのＮＰＣを新たに追加することも可能である。
&gt; 
&gt; ３．イベントの展開
&gt; 　最初に主催者（ゲームマスター、以下ＧＭ）が、メインとなる学校行事とメインＮＰＣの状況（スタート時の位置）を発表する。
&gt; 　プレイヤーはそれを受けて各々のＰＣの行動を考えて書き込みをする。また、他の参加者の書き込みを受けて、続きを考えて書き込む。
&gt; 　物語を進める期間（以下、セッション）は３日～１週間。
&gt; 　その後、１～２ヵ月の充電期間（以下、インターバル）を置き、ＧＭとプレイヤーはその間に次回の「行事」と状況の設定を話し合って決定しておく。
&gt; 　感想や追加の設定、アイデアや要望などもこの間に書き込んでもらう。
&gt; 
&gt; －「行事」の例－
&gt; 　第一話　…　入学式、始業式（ＨＲ）、クラブ勧誘での様子
&gt; 　第二話　…　一学期のある日の放課後の様子
&gt; 　第三話　…　夏休み、サマーキャンプでの様子
&gt; 　第四話（最終話）　…　文化祭での様子
&gt; 
...
削除キー <input type=password name="pwd" size=10 value=""> 入力コード N0DXBz  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="N0DXBz"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
