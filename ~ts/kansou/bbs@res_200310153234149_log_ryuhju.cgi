...
<input type=hidden name="nj" value="hJ93DXDByW">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:[TheDark]なるほど。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ すなさん
&gt; ＞エクトプラズムって、纏えるんですねぇ（笑）。
&gt; 
&gt; それにしても、口から出した物を被るとは…。
&gt; 『種別：かぶりもの』って表書きの理由がこれだったとは（笑）
&gt; 
&gt; それにしても、本当に戻れるんでしょうか？（実はもとに戻れなかったりして。）</textarea><br>
