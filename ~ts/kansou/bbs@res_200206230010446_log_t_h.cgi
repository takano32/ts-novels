...
<input type=hidden name="nj" value="CKbbTzhVZU">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:『終わらない現実』の感想"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ Ｔ・Ｈさん
&gt; ▼ きりきりさん
&gt; &gt; 読みました。
&gt; &gt;
&gt; &gt; 良かったです。
&gt; &gt; T・Hさんのように自由な発想を作品に取り入れる方は、好きです。
&gt; &gt;
&gt; &gt; 魂のコピーを他人の体に宿らせる作品は、私も読んだ事がありません。
&gt; &gt; 実は、私もT・Hさんのアイディアは、考えた事がありました（私だけでは無いと思いますけど）。
&gt; &gt; ですが、TSの読み物として萌えれるかなという不安もありました。
&gt; &gt;
&gt; &gt; しかし、T・Hさんの作品を見る限り、良い感じのストーリになっているうようですね。
&gt; &gt; 奈々ちゃんの生きていた時の記憶が残っている設定が、話に深みを与えていると思いました。
&gt; &gt; 実際、臓器を移植した方も臓器を提供してくれた方の記憶が臓器の細胞に残るみたいですから、脳が死んでも記憶は残るのは、自然ですね。
&gt; &gt;
&gt; &gt; 最後に魂の事ですが、昔、テレビで魂は、分割するだけでなく、結合もするというのを見た事あります。
&gt; &gt; TSにしずらいオカルトネタですけど、T・Hさんの話作りの参考になれば幸いです。
&gt; &gt;
&gt; &gt; これからの作品も期待しています。
&gt; 
&gt; ありがとうございます。良い感じのストーリーでしたか。
&gt; 初期設定とはかなり変わってしまってこうなったんですけどね（＾－＾；
&gt; 魂結合ですか、確かにネタになりそうな、、、どうでしょう？</textarea><br>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200303145220402&log=t_h">返信</a>　削除<input type=checkbox name="target" value="200303145220402"></font>
</td></table>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200303145135203&log=t_h">返信</a>　削除<input type=checkbox name="target" value="200303145135203"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200303145005634&log=t_h">返信</a>　削除<input type=checkbox name="target" value="200303145005634"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200208073221159&log=t_h">返信</a>　削除<input type=checkbox name="target" value="200208073221159"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200208014234121&log=t_h">返信</a>　削除<input type=checkbox name="target" value="200208014234121"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200207243230018&log=t_h">返信</a>　削除<input type=checkbox name="target" value="200207243230018"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200206230010446&log=t_h">返信</a>　削除<input type=checkbox name="target" value="200206230010446"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200206230005925&log=t_h">返信</a>　削除<input type=checkbox name="target" value="200206230005925"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200206230005557&log=t_h">返信</a>　削除<input type=checkbox name="target" value="200206230005557"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200206230005210&log=t_h">返信</a>　削除<input type=checkbox name="target" value="200206230005210"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td align=center nowrap><strong><font size=+1>[<a href="bbs.cgi?log=t_h">更新</a>] [<a href="http://ts.novels.jp/">終了</a>]</font></strong></td>
</tr></table><p>
<table border=0 cellpadding=4 cellspacing=0><td>
