...
<input type=hidden name="nj" value="TrAfFadTmE">
<input type=hidden name="res" value="1684">
<h4 align=center>▽ 記事番号 1684 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:宴の後に・・・（皆さんに感謝（＾＾）"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 演劇がーるず＠ｋａｇｅｒｏｕ６さん
&gt; 
...
&gt; 
&gt; またいつの日か、どこかでお会いしましょう(^-^)ﾉｼ</textarea><br>
