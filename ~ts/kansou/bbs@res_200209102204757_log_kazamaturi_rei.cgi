...
<input type=hidden name="nj" value="Wyl6W3xNDc">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:差し替えのお知らせ"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 運営委員さん
&gt; 作者の風祭玲さんの意向により、一部の展開などを修正した改訂版と差し替えました。</textarea><br>
