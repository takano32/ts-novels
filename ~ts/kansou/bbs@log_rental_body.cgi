...
<title>レンタルボディシリーズ 感想掲示板</title>
</head>
<body bgcolor=#bbffff text=#606080 link=#806060 vlink=#806060 alink=#806060>
<div align=left>
<font size=5>レンタルボディシリーズ 感想掲示板</font>
<table cellpadding=4 cellspacing=0><tr><td align=left>
<form method=POST action="bbs.cgi">
<input type=hidden name="mode" value="write">
<input type=hidden name="log" value="rental_body">
<input type=hidden name="nj" value="t7s0xOhQw0">
...
削除キー <input type=password name="pwd" size=10 value=""> 入力コード miOl85  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="miOl85"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
...
<td align=center nowrap><strong><font size=+1>[<a href="bbs.cgi?log=rental_body">更新</a>] [<a href="http://ts.novels.jp/library.html">終了</a>]</font></strong></td>
</tr></table><p>
<table border=0 cellpadding=4 cellspacing=0><td>
