...
<input type=hidden name="nj" value="YsgHAz30TX">
...
&gt; それはおいといて
&gt; 
&gt; 長かったけど、引き込まれましたねぇ。読んでて時間経過がすごかった。ちょっとした浦島太郎状態（大げさ）。
&gt; 
&gt; 人でなくなってしまった彼女たちの哀しみが何とも言えませんね。
&gt; 谷口が瞳に言った「人じゃないかどうかなんて、その人が決めることだ。人が人であろうとすれば、それは人だ」というセリフが重いです。
&gt; そして、冷酷ともとれる瑠璃の行動。
&gt; 組織をまとめるために必要な、冷酷な部分を彼女は独りで負っていたんですよね。
&gt; 
&gt; 自分たちが生き延びるためには仕方がないと割り切っている（ように見えた）瑠璃と、そこまでしなくてもという思いの瞳。
&gt; そんな二人の違いは最期のシーンにも表れていました。
&gt; 谷口と対決し、消された瑠璃と、それを見届け、自ら消えた瞳。
&gt; そして、最期まで瞳のことを気に掛けていた谷口。
&gt; 谷口に託した瞳と、彼女と正面から接した谷口。ふたりは・・・。
&gt; 
&gt; そして、変わり果てた兄と会ってしまった茂。
&gt; その後の切れたような行動がさらに哀れでした。
&gt; 
&gt; そして、全てが終わったと思っていた矢先の、最後のシーン。
&gt; 一体、誰が・・・。
&gt; 終わり方がすげぇホラーでした（爆）。</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207291194100&log=kebo">返信</a>　削除<input type=checkbox name="target" value="200207291194100"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207140190447&log=kebo">返信</a>　削除<input type=checkbox name="target" value="200207140190447"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207011081007&log=kebo">返信</a>　削除<input type=checkbox name="target" value="200207011081007"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206296125357&log=kebo">返信</a>　削除<input type=checkbox name="target" value="200206296125357"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206160232605&log=kebo">返信</a>　削除<input type=checkbox name="target" value="200206160232605"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206160191815&log=kebo">返信</a>　削除<input type=checkbox name="target" value="200206160191815"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206156120103&log=kebo">返信</a>　削除<input type=checkbox name="target" value="200206156120103"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206156062543&log=kebo">返信</a>　削除<input type=checkbox name="target" value="200206156062543"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206156010813&log=kebo">返信</a>　削除<input type=checkbox name="target" value="200206156010813"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206112210438&log=kebo">返信</a>　削除<input type=checkbox name="target" value="200206112210438"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td align=center nowrap><strong><font size=+1>[<a href="bbs.cgi?log=kebo">更新</a>] [<a href="http://ts.novels.jp/library.html">終了</a>]</font></strong></td>
</tr></table><p>
<table border=0 cellpadding=4 cellspacing=0><td>
