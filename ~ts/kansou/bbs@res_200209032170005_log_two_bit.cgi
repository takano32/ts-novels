...
<input type=hidden name="nj" value="GnWZIF6CGI">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:ＴＯＭさん、感想有り難うございます"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 好風さん
&gt; □TOMさん
&gt; 　レス、遅れて申し訳ないです。
&gt; 　もう少し貯まったらと考えていたんですけど、誰からもなくて機を逃してしまいました。
&gt; 
&gt; ＞NScriptによる読み易さもあいまって、最後までストレス無く読めました。
&gt; 　そう言って貰えると嬉しいですね。
&gt; 　思った以上に反響がないので（先行公開をしていたのも原因なんですけど）、
&gt; こちらでは公開するべきじゃなかったのかなと、思ったりしてます（苦笑
&gt; 　九月一杯公開して、あっちは消すかな……
&gt; 
&gt; ＞最初っから死ぬって判ってるのは、それだけで目が離せなくなっちゃいますから。
&gt; 　ＴＯＭさんや米津さんには、Ｐｕｒｅの裏バージョンにあたるデザイアの方が
&gt; 合っていたかな？
&gt; 　いずれ、ネットの何処かで公開するとは思いますので、縁があったら読んでやって
&gt; ください。
&gt; 
&gt; ＞米津さんが、エッチですねって言っておられますが、僕もそう思います。
&gt; 　たっはっはっは……最高の褒め言葉と受け取ってます（笑
&gt; 
&gt; ＞次が楽しみ♪
&gt; 　次……ですか。
&gt; 　次、どないしようかな……</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200209032170005&log=two_bit">返信</a>　削除<input type=checkbox name="target" value="200209032170005"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207243000042&log=two_bit">返信</a>　削除<input type=checkbox name="target" value="200207243000042"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207210114730&log=two_bit">返信</a>　削除<input type=checkbox name="target" value="200207210114730"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207210032732&log=two_bit">返信</a>　削除<input type=checkbox name="target" value="200207210032732"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207195234508&log=two_bit">返信</a>　削除<input type=checkbox name="target" value="200207195234508"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207195205723&log=two_bit">返信</a>　削除<input type=checkbox name="target" value="200207195205723"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
