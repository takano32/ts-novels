...
<input type=hidden name="nj" value="c5FFkxiAM3">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:それではお言葉に甘えて"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 死郎さん
&gt; &gt; 辛口の批評に関しては、言いたいのなら言って下さい。
&gt; 
&gt; 　誤字や文法・表現の間違い以外で気になったのは、やはり世界観のまとまりですね。それ
&gt; についてはこの市場さんは褒められていたので、まあ好みの問題もあるのかも知れませんが。
&gt; 
&gt; 　これもこの市場さんが仰っている通り『新しい世界観を創り出す』という試みは評価した
&gt; いんですけれど、時代劇のようだと思ったら貨幣単位が西洋風だし、そうかと思えば『肉じ
&gt; ゃが』のような近代以降に完成したような物は出てくるし。
&gt; 　こういう点はギャグとして出したと言われれば納得もできるんですけど、それにしては笑
&gt; えないのが痛い。結局のところ、読者が作品世界をイメージする妨げにしかなっていないよ
&gt; うに感じるんです。
&gt; 
&gt; &gt; まぁ、世界観はごちゃまぜな感じですが…（＾＾；
&gt; 
&gt; 　とお書きのところを見ると、ご自覚はおありのようですね。
&gt; 　しかし前の書込みに書いた通り、話の進め方は上手いので今後に期待します。
&gt; 
&gt; 　要するにまあ、見せ方の問題なんだと思いますよ。今のところ読んでて、西洋風なのか東
&gt; 洋風なのか、はたまたこの世でまだ誰も見たことのない文化形態なのか――とイメージが固
&gt; 定できないんですけど、そのぶん『これこれこのような家で』『この人物はこんな形の衣服
&gt; を着ている』等々と細かい描写を入れるなり何なりしていただければ済む話のような気がし
&gt; ます。独自の世界観を築くのであれば、最低限そこまでやってほしいな……という一読者の
&gt; 希望だと思ってください。
&gt; 
&gt; 　でした。</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200306102095214&log=jisyou_himajin">返信</a>　削除<input type=checkbox name="target" value="200306102095214"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200306102041855&log=jisyou_himajin">返信</a>　削除<input type=checkbox name="target" value="200306102041855"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200306091065650&log=jisyou_himajin">返信</a>　削除<input type=checkbox name="target" value="200306091065650"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200306065025310&log=jisyou_himajin">返信</a>　削除<input type=checkbox name="target" value="200306065025310"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200306065015708&log=jisyou_himajin">返信</a>　削除<input type=checkbox name="target" value="200306065015708"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200306054023911&log=jisyou_himajin">返信</a>　削除<input type=checkbox name="target" value="200306054023911"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200306054013449&log=jisyou_himajin">返信</a>　削除<input type=checkbox name="target" value="200306054013449"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200306043213828&log=jisyou_himajin">返信</a>　削除<input type=checkbox name="target" value="200306043213828"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200306043012359&log=jisyou_himajin">返信</a>　削除<input type=checkbox name="target" value="200306043012359"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200306043004251&log=jisyou_himajin">返信</a>　削除<input type=checkbox name="target" value="200306043004251"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td align=center nowrap><strong><font size=+1>[<a href="bbs.cgi?log=jisyou_himajin">更新</a>] [<a href="http://ts.novels.jp/library.html">終了</a>]</font></strong></td>
</tr></table><p>
<table border=0 cellpadding=4 cellspacing=0><td>
