...
<input type=hidden name="nj" value="686nlWwE74">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:これは斬新ですね"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 城弾さん
&gt; 　呪いによるＴＳというのはないこともないわけですが
&gt; （例・「らんま１／２」）
&gt; それがチェスのコマによるものというのは斬新な気がします。
&gt; 　ただ文庫さんに送るとなるとクィーン限定になりそうですが
&gt; 　ほかに女性というコマはあるんでしょうか？
&gt; 
&gt; 　なかなか素直になれないヒロインなんかもいいかなと思います。
&gt; 
&gt; 　この後は頻繁にチェスをすることになりそうですね。
&gt; 
&gt; 　楽しませていただきました。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード CdG2jP  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="CdG2jP"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200702246121250&log=omochibako">返信</a>　削除<input type=checkbox name="target" value="200702246121250"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200702191104327&log=omochibako">返信</a>　削除<input type=checkbox name="target" value="200702191104327"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200702191000636&log=omochibako">返信</a>　削除<input type=checkbox name="target" value="200702191000636"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
