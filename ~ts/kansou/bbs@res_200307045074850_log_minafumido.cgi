...
<input type=hidden name="nj" value="teYXbv5fs7">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:ミーナ 第8話 感想"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ SORAさん
&gt; ハチロクは? 魔臼は? (^^;
&gt; とりあえず時間無いのでいまはこれだけ。m(__)m</textarea><br>
