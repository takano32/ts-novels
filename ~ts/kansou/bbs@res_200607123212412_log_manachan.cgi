...
<input type=hidden name="nj" value="nfRbi5DvDu">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:面白い"><br>
...
&gt; &gt; 「由紀」の間違いでは無いのか！？
&gt; 
&gt; この間違いを探したところ、発見できました。
&gt; 後ほど修正しておきます。
&gt; ご指摘ありがとうございました。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード Gb0Ezb  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="Gb0Ezb"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
