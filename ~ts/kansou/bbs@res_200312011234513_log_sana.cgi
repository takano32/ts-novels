...
<input type=hidden name="nj" value="Jk0HUL7SWA">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:ホントは前後編"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ sanaさん
&gt; いつもお世話になっております、sanaです。
&gt; ｍｋ８４２６さん、感想ありがとうございます。
&gt; 
&gt; 続きが気になる書き方をして、申し訳ありません(~_~；）
&gt; ええ、図ったように鬼引きです。狙い通りに引いてしまいました。
&gt; というのも、タイトルにあるように、ホントは前後編でした。
&gt; ですから、引きも許されるかなーと安易な考えで、執筆したのですが…。
&gt; 投稿せねばー、という強迫観念に襲われ…後編が未完成のまま耐えきれず投稿…。
&gt; 「後編はどうしたー」と言われると、手直しの最中ですとしか答えようがないです、ハイ。
&gt; 
&gt; １２月中は非常に忙しく、どうなるか分かりませんが、早いうちに仕上げてさっさと物語を動かしたいと思います。
&gt; …まだ、最初の一日も終わっていないですし(･_･;)
&gt; エピソードの厳選が出来ていませんね、私。テンポが悪い。
&gt; 
&gt; 実のところ。この話は、学園ものにするつもりなのです。
&gt; その割には、一話にしか出てきてない学校とクラスメイト……
&gt; ……あれ？(･_･?)
&gt; 
&gt; 感想ありがとうございました～（ＴｏＴ）/~~~
&gt; そして、この文を読んでくれた奇特な方々、ありがとうございます。</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312044103103&log=sana">返信</a>　削除<input type=checkbox name="target" value="200312044103103"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312044011307&log=sana">返信</a>　削除<input type=checkbox name="target" value="200312044011307"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312033224646&log=sana">返信</a>　削除<input type=checkbox name="target" value="200312033224646"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312033221503&log=sana">返信</a>　削除<input type=checkbox name="target" value="200312033221503"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312033212847&log=sana">返信</a>　削除<input type=checkbox name="target" value="200312033212847"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312033163051&log=sana">返信</a>　削除<input type=checkbox name="target" value="200312033163051"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312033142430&log=sana">返信</a>　削除<input type=checkbox name="target" value="200312033142430"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312022213339&log=sana">返信</a>　削除<input type=checkbox name="target" value="200312022213339"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312011234513&log=sana">返信</a>　削除<input type=checkbox name="target" value="200312011234513"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200312011081359&log=sana">返信</a>　削除<input type=checkbox name="target" value="200312011081359"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
