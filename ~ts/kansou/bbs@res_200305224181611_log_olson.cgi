...
<input type=hidden name="nj" value="5GUdQCiKNI">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:「甲子園の魔物」読みました"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ シルルさん
&gt; 誠サマがカッコ良いです！
&gt; オネーサマと呼ばせてください。</textarea><br>
