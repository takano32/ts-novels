...
<input type=hidden name="nj" value="b0UUJckF9I">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:＞『いらっしゃいませ！　第一話』"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ Ｊ・Ｆさん
&gt; 正体は秘密・絶対にばらせない、というのはこの手の話のお約束ではありますが…………
&gt; まさかそういう理由とは（笑）　かなり斬新ですね。
&gt; 
&gt; ほのぼのラヴコメ路線か、ドタバタ無敵看板娘路線か。
&gt; どっちに傾くか妄想しつつ、今後の展開に期待します。</textarea><br>
