...
<input type=hidden name="nj" value="ZZwiR5eOUh">
<input type=hidden name="res" value="243">
<h4 align=center>▽ 記事番号 243 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
...
&gt; ＞[242] 望希さん
&gt; 　こんばんは、Taikaです。
&gt; 　自分の名前を検索してみるというのは誰しも一度はやることなのでしょうか、私もやってみたことがあります（笑）。
&gt; 　読んでくださってありがとうございました。</textarea><br>
