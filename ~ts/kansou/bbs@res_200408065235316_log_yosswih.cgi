...
<input type=hidden name="nj" value="o37C0YXuF8">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:みなさま感想ありがとうございました。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ よっすぃーさん
&gt; 当初「個別にお返事を」と思ったのですが、重複する内容も多いのでまとめてお返事させてください。
&gt; 
&gt; もともとこの作品は「某商業出版」に投稿したライトノベルです（長さが文庫本1冊分なのはその関係）。結果は見事没だったので、加筆修正して投稿しました。幾人の方が「ＴＳ要素が少ない」と指摘されるのは「文庫」的には当然かもしれません。
&gt; 本来ここはＴＳ小説の専門サイトですので、内容的に？　とは思ったのですが、「せっかく書いたのだから日の目を見せよう」という理由で投稿したのでそのあたらはご勘弁を。
&gt; どちらにせよ私の場合「ＴＳ」は添え物見たいな感じになり、話の目的ではなくネタの手段で使っております。まぁこの界隈には星の数ほど物書きがいますので、こんな奴が１人位いてもいいですよね？
&gt; ネタ的にはこの話、マクロス＋ヤマト＋ガンダムみたいな感じでしょうかね？　シルフィードのイメージは知る人ぞ知るＳＦＸ「マイティ・ジャック」のＭＪ号です。
&gt; ＢＧＭはビジュアルバンドのはしり、スペクトラムの「インザ・スペース」を聴いていただけると嬉しい限りです。
&gt; ちょっと話が脱線しましたが、最後まで読んでいただいてありがとうございました。</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200408076063744&log=yosswih">返信</a>　削除<input type=checkbox name="target" value="200408076063744"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200408065235316&log=yosswih">返信</a>　削除<input type=checkbox name="target" value="200408065235316"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200408054235046&log=yosswih">返信</a>　削除<input type=checkbox name="target" value="200408054235046"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200408054224709&log=yosswih">返信</a>　削除<input type=checkbox name="target" value="200408054224709"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200408054160847&log=yosswih">返信</a>　削除<input type=checkbox name="target" value="200408054160847"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200408054151929&log=yosswih">返信</a>　削除<input type=checkbox name="target" value="200408054151929"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200408054011812&log=yosswih">返信</a>　削除<input type=checkbox name="target" value="200408054011812"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200408043122018&log=yosswih">返信</a>　削除<input type=checkbox name="target" value="200408043122018"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200408032200850&log=yosswih">返信</a>　削除<input type=checkbox name="target" value="200408032200850"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200407235205417&log=yosswih">返信</a>　削除<input type=checkbox name="target" value="200407235205417"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
