...
<input type=hidden name="nj" value="N1Z3zpSQXG">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re3:オエスト"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ xさん
&gt; ▼ NHKさん
&gt; 堀井氏も容認するオエスト(TDQ)は笑えますよ。検索すればx68000エミュレータで合法(音楽だけはJASRACにより例外とか?)でプレイできます(笑)</textarea><br>
