...
<input type=hidden name="nj" value="Jwy3ewFdPn">
<input type=hidden name="res" value="399">
<h4 align=center>▽ 記事番号 399 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:モーヲタ！"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 塵芥王さん
&gt; 真城さん、そうだったのですか！
&gt; あまりにも偏りすぎのネタにお付き合いいただき、ありがとうございます。^_^;
&gt; 
&gt; 
&gt; それから、すなさんのご心配ですけども、某グループには最近、20歳をある程度過ぎると肩たたきが始まる傾向があるようなんですが……。
&gt; 
&gt; はっ！　まさか、アフターケアもばっちりに、13歳から成長しないかもしれませんねぇ(待ちなさい…)。</textarea><br>
