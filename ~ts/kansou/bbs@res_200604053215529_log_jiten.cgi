...
<input type=hidden name="nj" value="TdOL7qXng1">
<input type=hidden name="res" value="1906">
<h4 align=center>▽ 記事番号 1906 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:企画「Ｔ'ｓＨｅａｒｔ（仮）」に関する提案（２）"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 南文堂さん
&gt; 企画「Ｔ'ｓＨｅａｒｔ（仮）」に関する提案（１）より続き
&gt; 
&gt; 　定期的なので運営側が負担になる可能性がありますが、運営者が４人ぐらいいれば、一ヶ月に一回のお仕事で済みます。たとえ、急用ができても他の運営者がいれば、フォローが利きますので問題ないでしょう。
&gt; 　また、４イベント＝１クールといったような区切りをして、１クールが終わるごとに２週ほど間を置けばさらに楽になります。参加者はその２週間で日常パートを演じて書き込んだりして、まったりと楽しむ事も可能です。
&gt; 　イベント内容、選択肢、結果などはあらかじめある程度は用意しておけば、運営者はさして忙しくはありませんから、掲示板の監視に集中できます。２週間のインターバルをつくれば、参加者や読者の意見を聞いておけます。そうすれば、その後の展開やイベントの方向性も修正することは比較的容易で面倒でないでしょう。
&gt; 
&gt; 　掲示板は混乱を避けるために、『イベント告知』『イベント実況』の２面必要となりますが、『イベント告知』はオフィシャル専用なので実質的に管理するのは『イベント実況』の一面ですので、手間は一面と変わりありません。
&gt; 
&gt; 　参加者が定期的に書き込まなければならないと思う人もいるかも知れませんが、イベントを途中、飛ばしても支障はないです。競争ではないので、選択に間に合わなくても、『選択しない』＝『変化なし』ということで、リアクションに参加することはできます。そういったことなので、途中参加も簡単にできます。
&gt; 　また、選択しわすれたが、『変化なし』はいやだという場合は、ある種のルールを決めておき、自動的に選択した事にする方法もできます。＜例：（その人の最後の発言番号÷選択肢数）の余り＋１など＞
&gt; 
&gt; 　参加者同士の交流を円滑にするため、他者のキャラクターを絡ませる時は書き込みのルールを制定しておく。
&gt; 　他者のキャラクターに呼びかけた場合、書き込みの一番上に『＞●●さん』と呼びかけたキャラクター名を明記しておく。そうすれば、書き込みをチェックする際も全部を読む必要はなく、呼びかけのあった書き込みだけ優先的に読めば対応に遅れる危険も少なくなります（これはＮＰＣにおいても同じ。この件は後述する）。
&gt; 　もちろん、呼びかけに必ず応じる必要はない。応じられなくても、恨みっこなしなのは当然のこと。
&gt; 
&gt; 　閲覧者に対しても閲覧を楽にするために、『題名』のつけ方を定義しておく。
&gt; 　話の基点となる場合（誰かに最初に呼びかけたりした場合）、『（タイトル名）１』とナンバーを振っておく。それを受けた人は２、３……と書き込み順にナンバーをつけていくことにする。閲覧する人はそのタイトルとナンバーを追えば、連続した話を読むことができる。
&gt; 　掲示板の検索機能を使えば追うのも楽になります（検索するのに、題名は１語などシンプルでないものにすると検索しやすくなりますが、その辺は参加者の閲覧者を意識しているかどうかに現れるでしょう）。
&gt; 
&gt; 　前述したＮＰＣに関することですが、ＮＰＣは共用のキャラクターでありますが、それが同時にあっちこっちに出没しては変になります。そこで参加者が使用する際は『＞（ＮＰＣ名）』と明記して、その場の使用権を主張する必要があります。優先度はわかりやすいように早い者勝ちにしておきます（１時間ほどの誤差でほぼ同時に使われた時は仕方ないので、ＮＰＣに分身の術を使ってもらいます）。
&gt; 　ただ注意して欲しいのは、早い者勝ちだからといって占有しない事。そこは参加者のモラルに頼るところです。ＮＰＣの扱いに関しても同じですね。他の人が使いにくいようなことはしない。ＮＰＣは共有のものなので、みんなで仲良く使いましょう――という当たり前の事です。
&gt; 
&gt; ――以上。
&gt; 
&gt; 　参加者、読者、運営者と三者に不便さが少しずつある『三方一両損』なシステムなので不満が出る可能性がありますが、いかがでしょうか？
&gt; 
&gt; ＞ＭＯＮＤＯさん
&gt; 　ほどよくまとまりかけていますし、掲示板でみんなで話し合うのもいいのですが、そろそろ企画運営委員会を設立して、企画運営委員を募って、そこで企画を推進してはいかがですか？
&gt; 　もしそうするつもりがおありなら、企画運営に立候補します。微力ながらお手伝いいたします。</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード oVETtY  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="oVETtY"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200608012142640&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200608012142640"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200608012141700&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200608012141700"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200607145215431&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200607145215431"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200604075212036&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200604075212036"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200604053215529&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200604053215529"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200604053215440&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200604053215440"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200604053152638&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200604053152638"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200604031231025&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200604031231025"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200604031230912&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200604031230912"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200604020004010&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200604020004010"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200604016015713&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200604016015713"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200603304224815&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200603304224815"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200603293163824&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200603293163824"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
<font size=3 color=#606060><font color="#ff88cc">＞ＭＯＮＤＯさん</font><br>
<br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200510193220725&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200510193220725"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200510156041051&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200510156041051"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200510134213600&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200510134213600"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200509272001446&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200509272001446"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200509261015326&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200509261015326"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200509246221043&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200509246221043"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200509202013945&log=jiten">返信</a>　削除<input type=checkbox name="target" value="200509202013945"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
