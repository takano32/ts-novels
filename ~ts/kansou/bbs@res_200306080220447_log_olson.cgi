...
<input type=hidden name="nj" value="LgbTJswTeg">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:久々に覗いてみたら……"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ OLSON@久々さん
&gt; 久々に覗いてみたら更なる感想が！
&gt; シルルさん、あんたが好きサさん、気に入っていただけて嬉しいです。
&gt; でも残念ながらTSネタは今のところネタ切れです。引退する気はないのでネタが浮かび次第執筆させていただきます。
&gt; 最近発表したDNMLは……原作での男キャラが実は男装の麗人だった……という設定だからTSとはちと違うし。
&gt; 
&gt; なお、拙作ペットボトルが気に入り、18禁の続編を書かせて欲しいという方が現れました。
&gt; この少年少女文庫ではポルノ不可ゆえに使えなかったネタを提供の上で、面白くまとめていただきました。
&gt; ２CHの
&gt; もし理想の女性に生まれ変わったら… その4
&gt; ttp://www2.bbspink.com/test/read.cgi/eroparo/1042164477/l50にて『瓶』というハンドルにて連載されました。
&gt; 更にはイラストまで描いていただきました。（残念ながらもうリンク先は流れてしまいましたが）
&gt; ここまで気に入っていただき幸せです。</textarea><br>
