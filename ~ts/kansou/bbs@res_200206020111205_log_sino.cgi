...
<input type=hidden name="nj" value="EOAJwp3rC4">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:ts熱唯史"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 電波妖精さん
&gt; なにはともあれ、そんな経験をするのもありか。
&gt; うーん。リアリティがあるなあ。エッチつきのデートを申し込むって…
&gt; 続きが気になりますね。</textarea><br>
