...
<input type=hidden name="nj" value="voYnHIunLU">
<input type=hidden name="res" value="1675">
<h4 align=center>▽ 記事番号 1675 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:感想書いた後ですが、皆様レース後の描写を書いてらっしゃるようなので便乗いたします。"><br>
...
&gt; 　魂は妖怪なんで死んだらあのでかい棺の中へ戻ってきますよ。それでは！</textarea><br>
