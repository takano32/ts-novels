...
<input type=hidden name="nj" value="uU6oHlzJUP">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:にょう"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 電波妖精さん
&gt; この作品から萌えをとったら…。
&gt; とりあえず萌えカスぐらいは残ると思います(笑）
&gt; まあ、この萌えもすべては布石だと思いたいですね。
&gt; ハードなストーリーをバックに展開する萌え…。
&gt; それが目指すべき到達点だったりーの。</textarea><br>
