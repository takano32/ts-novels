...
<input type=hidden name="nj" value="eJfb65IIqa">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:女の子座り（Ｍ字座り）"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ オセッカイザーＥＸさん
&gt; 女の子座り（Ｍ字座り）の正式な名称は「割座（わりざ）」、「レレ座り」（横座り）は「鳶足（とびあし）」というそうです（大辞泉の「すわる」の項に絵入りで出ているとか）。但し、「割座」は足の甲を床につけ、つま先を後方に向けるが、足の内側を床につけ、つま先を左右に向けるのは「亀居（かめい）」というのだとか
&gt; ttp://www3.ocn.ne.jp/~gthmhk/dskrmnc.html#hanasiwoより無断転載　削除キー １２３</textarea><br>
