...
<input type=hidden name="nj" value="gR2YCwWnTZ">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:メタモル・ヴァンパイアその３読了"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 電波妖精さん
&gt; しぶいね…。いやコメディが強くなったとはいえ、やはりところどころで渋いですよ。
&gt; 特に設定が燃えるなぁ…。
&gt; 吸血鬼関係が相当程度しっかりしていますね。
&gt; さて次回はついにTS遊びが…。ごくり。</textarea><br>
