...
<input type=hidden name="nj" value="HFmKVeXJjI">
<input type=hidden name="res" value="1672">
<h4 align=center>▽ 記事番号 1672 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
名前 <input type=text name="name" size=45 value="" maxlength=64><br>
E-Mail <input type=text name="email" size=45 value="" maxlength=200><br>
URL <input type=text name="url" size=45 value="" maxlength=200><br>
</td></tr>
<tr><td align=left nowrap>
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:ＥＰＩＳＯＤＥ４３｢愛情｣"><br>
