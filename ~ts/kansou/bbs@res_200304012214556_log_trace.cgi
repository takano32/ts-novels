...
<input type=hidden name="nj" value="GCmOghpevg">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:読ませて・・・"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ alienさん
&gt; 読ませていただ…いてません(笑)
&gt; 途中まで読んでとりあえず一言
&gt; 
&gt; 「いい加減な事をしたら腕立て百回だからな!!」
