...
<input type=hidden name="nj" value="fPFcDZkZeL">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:電波妖精は風のごとく読んだかもしれない。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 電波妖精さん
&gt; 口移し……。(；´Д｀)かなり萌えました。
&gt; こういうシチュエーションには弱いなぁ。</textarea><br>
