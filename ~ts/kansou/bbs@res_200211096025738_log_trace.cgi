...
<input type=hidden name="nj" value="AtbeSFYOPi">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:人の命は尽きるとも、世にネタは付きまじ。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ H/Qさん
&gt; 　人の命という存在が不自然に消失したとき、消えた本人以外はその謎を求め東奔西走し、何とか理由をつけようとする。人、それを推理という！！
&gt; 
&gt; 
&gt; ・・・外したかな（汗）
&gt; こんばんは、ここの所ここにずっと来られず、ようやく来れる時間ができたH/Qと申すものです。
&gt; 今回、一気に二話読ませていただきました。
&gt; 何となく京極夏彦の姑獲鳥(うぶめ)の夏のトリックを彷彿とさせるトリック。
&gt; いいじゃないですか。
&gt; 構成要素こそ確かに某少年タキシード探偵と似通ったものがありますが、あの作品も連載当初は某雑誌弾莢に載っていた高校生名探偵の始祖のパクリと叩かれていたのですから、がしがし開き直ってくださいな（笑）
&gt; 評価というものは、後からついてくるものなのですから。
&gt; では、これからの展開に期待しつつ。</textarea><br>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200301120145535&log=trace">返信</a>　削除<input type=checkbox name="target" value="200301120145535"></font>
</td></table>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200301050234602&log=trace">返信</a>　削除<input type=checkbox name="target" value="200301050234602"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200301050094303&log=trace">返信</a>　削除<input type=checkbox name="target" value="200301050094303"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200301046145157&log=trace">返信</a>　削除<input type=checkbox name="target" value="200301046145157"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200301046104922&log=trace">返信</a>　削除<input type=checkbox name="target" value="200301046104922"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200212043220451&log=trace">返信</a>　削除<input type=checkbox name="target" value="200212043220451"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200212021111816&log=trace">返信</a>　削除<input type=checkbox name="target" value="200212021111816"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200212010233941&log=trace">返信</a>　削除<input type=checkbox name="target" value="200212010233941"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200212010183536&log=trace">返信</a>　削除<input type=checkbox name="target" value="200212010183536"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200211122205632&log=trace">返信</a>　削除<input type=checkbox name="target" value="200211122205632"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
