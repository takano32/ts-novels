...
<input type=hidden name="nj" value="JT3HAeGmXX">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:あ、忘れてた。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ TOMさん
&gt; 雨音はショパンの調べ、私は原曲は大好きです。
&gt; 小林麻美バージョンはイマイチですが。
&gt; 他にもいろいろ散らばってる小ネタがいいですね。
&gt; こういうお遊びって、映画「タンポポ」を思い出したりして
&gt; すごくいい感じです。</textarea><br>
