...
<input type=hidden name="nj" value="ppoAYTjFL5">
...
削除キー <input type=password name="pwd" size=10 value=""> 入力コード Dv6CSz  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="Dv6CSz"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
