...
<input type=hidden name="nj" value="dVUgYLZeQ9">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:読みにくいです。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 一読者さん
&gt; 厳しい率直な感想を述べたいと思います。
&gt; はっきり言って最低です！
&gt; 冒頭で王国の産業が説明されていますが、これを読んでいやな予感がしました。
&gt; ファンタジー小説にありがちな末子枝葉の説明に陥ってしまうんじゃないかと。
&gt; 案の定、王国の系譜が語られるくだりで、逐一、こみいった事情が過剰に解説され、
&gt; メモを取らずに家系を想い描くのが辛くなりました。
&gt; 途中で読むのを投げ出してしまいました。
&gt; せめて、系統図でもあればよかったんですがね。
&gt; 読み疲れた時点で、ブラウザのスクロールバーの位置を見て、
&gt; この調子が続くのかとげんなりしました。
&gt; 推薦文でだいたい、オチが予想できるだけに読者を牽引する工夫が足りないんじゃないかと思います。
&gt; おそらく、ひらめきだけでパソコンに向かって執筆を開始したのではないですか?
&gt; まず、書店で売られている商業レベルの作品をいくつか目を通されてみてはいかがでしょう。
&gt; 今後の発展に期待します。</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200407014215426&log=writerman">返信</a>　削除<input type=checkbox name="target" value="200407014215426"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406266085942&log=writerman">返信</a>　削除<input type=checkbox name="target" value="200406266085942"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406266065356&log=writerman">返信</a>　削除<input type=checkbox name="target" value="200406266065356"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406266012453&log=writerman">返信</a>　削除<input type=checkbox name="target" value="200406266012453"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406255141405&log=writerman">返信</a>　削除<input type=checkbox name="target" value="200406255141405"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406244235849&log=writerman">返信</a>　削除<input type=checkbox name="target" value="200406244235849"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406244214420&log=writerman">返信</a>　削除<input type=checkbox name="target" value="200406244214420"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
