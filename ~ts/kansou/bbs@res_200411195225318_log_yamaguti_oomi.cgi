...
<input type=hidden name="nj" value="gQwPDle8Rs">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:ありがとう"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 山口　多聞さん
&gt; みなさん、ありがとうございました。次回もお楽しみに。
&gt; 
&gt; って、テストがもう１１日前</textarea><br>
