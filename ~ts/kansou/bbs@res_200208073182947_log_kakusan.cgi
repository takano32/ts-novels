...
<input type=hidden name="nj" value="NymBFyL2xI">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:うひゃあ"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ ノイン（電波妖精）さん
&gt; 前編、後編と読みました。
&gt; 登場人物がだれもかれも濃くて、良い感じです。
&gt; シリアス、ギャグとバランスがとれている配置ですね。
&gt; 鈴ちゃんと士郎のかけあいもよかった。法子さんもよかった。（笑）
&gt; 主人公が影うすいよお・・・普通すぎるせいかな。
&gt; とはいえ、それを補うための一人称。うまいですね。
&gt; そして、話はシリアスに進んでいって、
&gt; 先へ先へと視線を駆り立てられました。
&gt; うーむ、ほんとにすごい・・・。
&gt; 最終章、ほんとに待ってます。
&gt; しかし、気になったのは前編のあとがきの・・・あれと
&gt; ゼロ話の・・・
&gt; ハッピーなエンドにはならなさそうな感じなので、
&gt; どうなるか気になりますね。
&gt; 
&gt; オマケも楽しかったです♪</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200208073182947&log=kakusan">返信</a>　削除<input type=checkbox name="target" value="200208073182947"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207280205724&log=kakusan">返信</a>　削除<input type=checkbox name="target" value="200207280205724"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207243022035&log=kakusan">返信</a>　削除<input type=checkbox name="target" value="200207243022035"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207206175900&log=kakusan">返信</a>　削除<input type=checkbox name="target" value="200207206175900"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207195203801&log=kakusan">返信</a>　削除<input type=checkbox name="target" value="200207195203801"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207195013651&log=kakusan">返信</a>　削除<input type=checkbox name="target" value="200207195013651"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207173205536&log=kakusan">返信</a>　削除<input type=checkbox name="target" value="200207173205536"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207162105558&log=kakusan">返信</a>　削除<input type=checkbox name="target" value="200207162105558"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207162032933&log=kakusan">返信</a>　削除<input type=checkbox name="target" value="200207162032933"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200207162010713&log=kakusan">返信</a>　削除<input type=checkbox name="target" value="200207162010713"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td align=center nowrap><strong><font size=+1>[<a href="bbs.cgi?log=kakusan">更新</a>] [<a href="http://ts.novels.jp/library.html">終了</a>]</font></strong></td>
</tr></table><p>
<table border=0 cellpadding=4 cellspacing=0><td>
