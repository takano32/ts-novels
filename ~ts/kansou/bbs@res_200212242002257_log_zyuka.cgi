...
<input type=hidden name="nj" value="aWN4fVcZZK">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:[夢オチ８]読みました。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ すなさん
&gt; とてつもなく直球な主人公の名前でしたねえ（あはは・・・）。
&gt; なかなかいけてました。
&gt; 
&gt; ところで、戦隊のコスチュームのデザインがとっても気になるのですが・・・？</textarea><br>
