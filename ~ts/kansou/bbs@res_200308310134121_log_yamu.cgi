...
<input type=hidden name="nj" value="F81pe1aCBI">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:・・・感想ありがとうございます。（それと反省文？）"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 夜夢さん
&gt; こんにちは、夜夢でございます。
&gt; 
&gt; 電波妖精様、NHK様、J・F様、この市場様、御感想ありがとうございます。
&gt; 
&gt; &gt;これはおそらく夜夢さんにとっても始めて？　のジャンルのようですし、
&gt; &gt;いわゆる実験小説だったのではないかと思います。
&gt; 
&gt; ・・・えぇ、その通りです。あとがきにも少し触れてますが、ホラー物を読んでないので、表現手法とかってのを今一つ理解せずに書き始めたきらいがあるのは否定できません。
&gt; 
&gt; &gt;今回のお話はホラーとしてみれば、やはり主人公を突き放しすぎてしまっているという印象を受けました。
&gt; &gt;したがって、読者としてはやはり主人公との自分との同一視ができず、感情が空転しています。
&gt; 
&gt; なるほど・・・普段の私のとる表現手法は、「主人公の守護霊の視点」（自称？）的な所から眺めた情景の描写ですからね。主人公を突き放して描いていると言うのは、言いえて妙なのかもしれませんね。
&gt; （・・・こう言う描写の仕方は、ホラー物には向かないと言うことですか・・・精進が必要ですね。）
&gt; 
&gt; 
&gt; ＞平穏な生活送っていた主人公の日常が、だんだん壊れていく感じがいい味だしてますね。
&gt; &gt;というわけで、Ｒメインの感想となりますが。
&gt; &gt;説明が細かく、随分とリアル指向だな、というのが第一印象でした。
&gt; &gt;実際にそういう現象を想像すると、ホラーとはちょっと違う意味で恐くなるというか。
&gt; ＞病気、ホラー、そして２本に分けた描写。
&gt; ＞新しい試みがうまくはまっていると思います。
&gt; 
&gt; ・・・こう言う風に言って頂けるとは、ありがたいことです。
&gt; 最初「pattern P」のみの掲載にしようかとも思っていたのですが、二本立てにして良かったと思います。やはり、「pattern R」を書く気になった分、「pattern P」の方も病状に関して少し詳しい描写を心掛ける結果となりましたし・・・
&gt; 
&gt; &gt;そういや、Ｒにあった年齢についての説明がＰでは未消化ですね。これがまた新しいネタになるのかも？
&gt; 
&gt; ・・・（カハイタワラヒ）
&gt; “羽化（？）”後の年齢変化は、統計学上の結果であって、全ての患者に対して見られる減少じゃありませんから・・・・・・ってのは言い訳です。すみません、鏡に映った女性の表現に「年若い」って文言を入れ忘れたんです!! m(_ _)m
&gt; 少し若返ってることを描写しようと思っておいて、いざ書く段になってコロッとそのこと忘れてたんです・・・・・・
&gt; 
&gt; ＞ただ、発表したところがここだってことが、ホラーとしては若干のマイナス要因になってしまってるような気がします。
&gt; ＞ここに掲載されてるってことで、病気の正体が予想できてしまいますから。
&gt; 
&gt; ・・・（カハイタワラヒ　其の二）
&gt; それは・・・半ば予想してました。話を半分ばかりも読めば、結果は予想出来ますものねぇ～～ここで・・・
&gt; 
&gt; ともあれ、次回はミストレスシリーズを出す予定ですが・・・・
&gt; ・・どなたか「FMS：pattern？」を書いてくれないものだろうか・・・（願望混じりの独り言です。）</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200310116233319&log=yamu">返信</a>　削除<input type=checkbox name="target" value="200310116233319"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200310083194058&log=yamu">返信</a>　削除<input type=checkbox name="target" value="200310083194058"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200310083193734&log=yamu">返信</a>　削除<input type=checkbox name="target" value="200310083193734"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200310072213544&log=yamu">返信</a>　削除<input type=checkbox name="target" value="200310072213544"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200310072175958&log=yamu">返信</a>　削除<input type=checkbox name="target" value="200310072175958"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200310072132204&log=yamu">返信</a>　削除<input type=checkbox name="target" value="200310072132204"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200310072013251&log=yamu">返信</a>　削除<input type=checkbox name="target" value="200310072013251"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200310072011110&log=yamu">返信</a>　削除<input type=checkbox name="target" value="200310072011110"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200310072004831&log=yamu">返信</a>　削除<input type=checkbox name="target" value="200310072004831"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200310061230552&log=yamu">返信</a>　削除<input type=checkbox name="target" value="200310061230552"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
