...
<input type=hidden name="nj" value="XmYtJP4o7Y">
<input type=hidden name="res" value="1908">
<h4 align=center>▽ 記事番号 1908 への返信 ▽</h4><table border=0 cellpadding=2 cellspacing=0><tr><td align=left nowrap>
...
削除キー <input type=password name="pwd" size=10 value=""> 入力コード 5v2lC0  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="5v2lC0"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
