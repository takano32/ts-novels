...
<input type=hidden name="nj" value="xsq7HCyRTN">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:『The voice of ours act.6』読みました"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ SORAさん
&gt; 二役がばれたとはいえ、女装の男ってところはまだばれていないのですね。
&gt; これがばれたときにどうなるのか…楽しみです。:-)</textarea><br>
