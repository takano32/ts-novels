...
<input type=hidden name="nj" value="oLcuCh0jkI">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:追加修正"><br>
...
&gt; の部分、修正しておきました。
&gt; 
&gt; 念入りに最初から読み直したつもりでも、まだ見落としてましたか。
&gt; 「以外」「意外」、「初め」「始め」なんかはやっぱり見逃しやすいです。
&gt; むぅ、修行不足なり。</textarea><br>
