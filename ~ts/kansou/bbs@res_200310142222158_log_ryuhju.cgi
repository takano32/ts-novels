...
<input type=hidden name="nj" value="MJHZ9O5TFV">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:「Ｔｈｅ Dark」、読みました。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ ＭＵＣＫさん
&gt; うーむ。ダーク、ですね。
&gt; こういうシニカルな展開は、クセになるかも。
&gt; 何かの作業の片手間、熱くなった頭を冷やすにはいいですね。こういうお話。
&gt; 
&gt; それでは、次回も楽しみにしております。</textarea><br>
