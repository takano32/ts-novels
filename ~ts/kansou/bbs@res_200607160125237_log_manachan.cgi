...
<input type=hidden name="nj" value="CbXrRk7KWA">
...
&gt; ▼ ナナシアさん
&gt; ご指摘のあった箇所の修正の完了が運営委員さんより連絡が来ました。
&gt; その後、私は正しいのを確認しました。
&gt; ↓に修正後の作品リンクを書いときます。
&gt; 
&gt; http://ts.novels.jp/novel/200509/07220814/imnotone_3.html</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード 2CW5dt  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="2CW5dt"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
