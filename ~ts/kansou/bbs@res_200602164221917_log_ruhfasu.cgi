...
<input type=hidden name="nj" value="uWQW6L4OeV">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:お話の続きは…"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 匿名希望さん
&gt; もう書かないのですか？楽しみにしているのですが…</textarea><br>
pre<input type=checkbox name="pre" value="1"> 
link<input type=checkbox name="link" value="1" checked> 
削除キー <input type=password name="pwd" size=10 value=""> 入力コード 65P2R4  <input type=password name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="65P2R4"> <input type=submit value="書き込む"><input type=reset value="書き直し"><br></td></tr></table>
</td></tr></table><br>
</form>
