...
<input type=hidden name="nj" value="y3FApY4f5X">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:作品解説"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ NHKさん
&gt; えと、ちょっとだけ作品解説しますね。
&gt; 
&gt; 今回は【RPG】と【仮想現実】をテーマに書きました。
&gt; 
&gt; 【RPG】主人公は現実世界では男性なのですが、ゲームの世界に於いては女の子僧侶を演じて（ロールプレイング）います。これは、アニメキャラのコスプレをしてそのキャラになりきるのと同じ状態だといえます。
&gt; 　ところが、この物語の場合、主人公は現実に戻れなくなってしまったため、キャラを演じ続けなければならなくなり、いつしか、仮初めであったはずの自分像（キャラ）が、現実に於ける自分像と擦り替わってしまいます。で、主人公は赤ん坊が欲しくなった訳です。
&gt; 
&gt; 【仮想現実】ぶっちゃけた話、この物語は『マトリックス』（監督　ウォシャウスキー兄弟）や『アヴァロン』（監督　押井守）と大して変わりありません。勿論、物語の完成度は桁違いですが……。
&gt; 　あぁ、眠たい。また明日、続きを書きます……。じゃ、明日が今日になったので続きを書きます。
&gt; 　さて問題です。『マトリックス』みたいに巧妙に作られた仮想現実（夢）と現実。この二つはどうすれば見分けることが出来るでしょうか？
&gt; 　これが夢ならば、目が覚めることによって自分が夢を見ていたことが証明されます。しかし、主人公はゲーム（夢）との接続を切ることが出来ない状態にあるので、これを証明することは不可能なのです。確かに主人公は現実世界での記憶を、ゲームの世界に持ち込んではいますが、記憶は確固たる証拠にはなりません。
&gt; 　つまり、覚醒できない以上、「現実か？夢か？」という問いは意味を失ってしまうのです。結果、主人公は（存在するかどうか不確かな）現実に戻る努力を諦め、自分がより幸福に生きられるゲームの世界で生きることを選択したのです。
&gt; 
&gt; 　最後に、この物語を読み直して思ったのですが、この物語って肉の付いていないTボーンステーキみたいな物語だなぁ。こんな中途半端な物語を読んでくださって有難うございます。</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406152033439&log=nhk">返信</a>　削除<input type=checkbox name="target" value="200406152033439"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406126135411&log=nhk">返信</a>　削除<input type=checkbox name="target" value="200406126135411"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406082223402&log=nhk">返信</a>　削除<input type=checkbox name="target" value="200406082223402"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406056093615&log=nhk">返信</a>　削除<input type=checkbox name="target" value="200406056093615"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406034232819&log=nhk">返信</a>　削除<input type=checkbox name="target" value="200406034232819"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406034143930&log=nhk">返信</a>　削除<input type=checkbox name="target" value="200406034143930"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406034024635&log=nhk">返信</a>　削除<input type=checkbox name="target" value="200406034024635"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200406034024151&log=nhk">返信</a>　削除<input type=checkbox name="target" value="200406034024151"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
