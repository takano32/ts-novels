...
<input type=hidden name="nj" value="0fdbYjlwGw">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:感想ありがとうございます2"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ sinoさん
&gt; あいさま　ＫＥＢＯさま　電波妖精さま
&gt; 感想ありがとうございます
&gt; 
&gt; ＴＳ熱
&gt; ＞これって流行したりしないのかなぁ・・・・（ＫＥＢＯさま）
&gt; エンドレスストーリーのツリーではそんな話が追加されていました。
&gt; クラスで流行ってしまうって展開でした。
&gt; 少子化の問題として女性が結婚しないという話がありますが
&gt; 政府が少子化対策としてウィルスを活性化させ
&gt; 男女のバランスを狂わすって言う話なんか想像できますが
&gt; （確か文庫に似た話はありますが）
&gt; 
&gt; ＞学校関係者よりむしろ女医さんがすごく普通で面白かったです。（ＫＥＢＯさま）
&gt; 学校関係者の展開はお約束ですね
&gt; ココでは当たり前過ぎて面白みが欠けるかも
&gt; 女医さんはＴＳ熱が珍しい病気なので積極的になってます。
&gt; たまたま相談した専門家が後遺症の研究をしていたため引きずられています。
&gt; 
&gt; ぱられる
&gt; ＞どこかで一度掲載されていませんでしたか？（あいさま）
&gt; ＞第二掲示板でも見てた記憶があるんですけど（電波妖精さま）
&gt; 電波妖精さまの仰るとおり「第二掲示板」で発表しました。
&gt; はじめて発表したのは後書きに書いているように「エンドレスストーリー」です。
&gt; 「エンドレスストーリー」で別のツリー（ＴＳ熱唯史の場合の元）を繋げるために
&gt; 「エンドレスストーリー」に参加したのですが
&gt; 自分のオリジナルを上げて見たくて書き始めました。
&gt; ファイルを整理していたら出てきたので「第二掲示板」に発表したら
&gt; 結構レスがついたので文庫に投稿するか悩んでいたのですが
&gt; （「第二掲示板」の作品はいずれ消えて行く運命にあるので）
&gt; 「ＴＳ熱」を上げるついでに文庫に投稿させていただきました。
&gt; 
&gt; ＞親友どうしがつきあう。いわゆる親友萌えがうまい具合にコンパクトにまとまっていると思いましたよ。うまい♪
&gt; そう評価していただけるとウレシイです。
&gt; もともとあの落ちは「エンドレスストーリー」の閉鎖に合わせて
&gt; 偽装恋人から本当の恋人になるお約束な展開を考えていたののを
&gt; 結末だけ強引に持ってきました。
&gt; 読み直してみたら他に書き換えが思い浮かばなくなり
&gt; 「第二掲示板」で反応を見てみようとしたのです。
&gt; 「第二掲示板」意見で結末に手を加えるか悩んだ為投稿の決断が
&gt; 着きませんでした。</textarea><br>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206182044900&log=sino">返信</a>　削除<input type=checkbox name="target" value="200206182044900"></font>
</td></table>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206160175400&log=sino">返信</a>　削除<input type=checkbox name="target" value="200206160175400"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206086071832&log=sino">返信</a>　削除<input type=checkbox name="target" value="200206086071832"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206075224423&log=sino">返信</a>　削除<input type=checkbox name="target" value="200206075224423"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206075142433&log=sino">返信</a>　削除<input type=checkbox name="target" value="200206075142433"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206075104011&log=sino">返信</a>　削除<input type=checkbox name="target" value="200206075104011"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206042071616&log=sino">返信</a>　削除<input type=checkbox name="target" value="200206042071616"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206020111205&log=sino">返信</a>　削除<input type=checkbox name="target" value="200206020111205"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206020005317&log=sino">返信</a>　削除<input type=checkbox name="target" value="200206020005317"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=right><font size=3>　<a href="bbs.cgi?res=200206016225259&log=sino">返信</a>　削除<input type=checkbox name="target" value="200206016225259"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td align=center nowrap><strong><font size=+1>[<a href="bbs.cgi?log=sino">更新</a>] [<a href="http://ts.novels.jp/library.html">終了</a>]</font></strong></td>
</tr></table><p>
<table border=0 cellpadding=4 cellspacing=0><td>
