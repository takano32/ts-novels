...
<input type=hidden name="nj" value="ENApfVLo1C">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:この場を借りて"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ TRACE900番台さん
&gt; まず運営委員のkouさま、作者のワガママを容認してくださって本当に申し訳ない。
&gt; 22日の昼に投稿したので、驚速で掲載して頂いた計算なのです。
&gt; 
&gt; &gt;▽ ｍｋ８４２６さま
&gt; &gt;これはまた楽しみなシリーズが始まったものです。
&gt; &gt;しかし、この設定・・・最高やねぇ（笑）。
&gt; 
&gt; …ホントは「怪盗紳士」第1話のオマージュの予定だったんですが…結局こんな形になりました。なぜ？
&gt; 「♀時々♂」の設定は個人的に気に入ったので、他の作品でも試してみたいですね。
&gt; （…って言って、今度はいつ投稿できるのやら）
&gt; 
&gt; ▽ よしおかさま
&gt; &gt;でも、おやじさんの行方が気になるのは、わたしだけ？
&gt; 
&gt; おやじさんの設定は思い付きです。苗穂を普段女の子として生活させるには、単に「正体隠すため」では本人も納得しないでしょうし。
&gt; ま、ギャグならそれでも良かったかも（笑）
&gt; 
&gt; ところで、登場人物の名前（苗字）には共通点があるのですが、皆さまお気付きでしょうか？
&gt; 
&gt; ともあれ、ご愛読ありがとうございます。</textarea><br>
