...
<input type=hidden name="nj" value="oavGovg1Lz">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:いいですよ！"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ ロシさん
&gt; この手の話って結構好きです。面白いと思いますが。</textarea><br>
