...
<input type=hidden name="nj" value="7IAZQPoBdY">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:こっそり感想ありがとうございます。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ ノインさん
&gt; 地駆鴉さん
&gt; 感想ありがとうございます。
&gt; ええっと、読解力うんぬんというよりも
&gt; この作品がよくわからないから、理解できなくて当然なのです。
&gt; なんというかわけのわからない領域というか無意識的な部分を表象したかったんです。
&gt; 理性が無理性部分（？）を抉り出すことができるかという命題でございました。
&gt; 最後がちょいと矛盾しているけど
&gt; それすらも彼女はわかっているのです。
&gt; 
&gt; ｍｋ８４２６さん
&gt; これまた感想書きにくい作品に感想ありがとうございます。
&gt; なんとなく抽象的になってしまいましたから、実験ではない小説ではもう少し具体的に抉り出せるようにしたいと思います。
&gt; ボクがしたかったことは無形のものに形を与える作業ですから。それもまた愛ということで。
&gt; 姫様…うい。送ります。できたらということで。
&gt; 
&gt; あいさん
&gt; 共感できるかどうかと愛と理性というふうに二重の論理レベルが錯綜しているためにわかりにくい作品になっているのだと思います。
&gt; 愛という言葉を使ったのがちょっとミスかもしれません。</textarea><br>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200302101205902&log=noin">返信</a>　削除<input type=checkbox name="target" value="200302101205902"></font>
</td></table>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200302101013425&log=noin">返信</a>　削除<input type=checkbox name="target" value="200302101013425"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200302090214321&log=noin">返信</a>　削除<input type=checkbox name="target" value="200302090214321"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200302090202251&log=noin">返信</a>　削除<input type=checkbox name="target" value="200302090202251"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200302086154930&log=noin">返信</a>　削除<input type=checkbox name="target" value="200302086154930"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200302086140453&log=noin">返信</a>　削除<input type=checkbox name="target" value="200302086140453"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200302075224203&log=noin">返信</a>　削除<input type=checkbox name="target" value="200302075224203"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200302075212739&log=noin">返信</a>　削除<input type=checkbox name="target" value="200302075212739"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200302075184105&log=noin">返信</a>　削除<input type=checkbox name="target" value="200302075184105"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td nowrap align=left><font size=3>　<a href="bbs.cgi?res=200301094232124&log=noin">返信</a>　削除<input type=checkbox name="target" value="200301094232124"></font>
</td></table>
<table border=0 cellpadding=16 cellspacing=0 width=100%><td>
...
<td align=center nowrap><strong><font size=+1>[<a href="bbs.cgi?log=noin">更新</a>] [<a href="http://ts.novels.jp/">終了</a>]</font></strong></td>
</tr></table><p>
<table border=0 cellpadding=4 cellspacing=0><td>
