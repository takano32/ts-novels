...
<input type=hidden name="nj" value="glISFxG3RL">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:変なつっこみをさせて頂きます。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ アカトリさん
&gt; 読みましたよ、干支さん。読んだ感じはまあ、普通でした。（こんなのですいません）
&gt; 後、高校までの知識で言うとＴＳに必要な知識は化学ではなく生物だと思います。……笑い飛ばせるようなどうでもいい突っ込みですが。</textarea><br>
