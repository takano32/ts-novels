...
<input type=hidden name="nj" value="Iola5XMDrQ">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:いつもいつも手直しばかりでごめんなさい。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ パンダ５さん
&gt; SMガールズ、最初は完全なギャグ路線を目指していたんですけど作っている途中辺りからこの設定を利用したシリアスな話を思いついてしまいまして・・・。
&gt; 大丈夫、もうこれ以上修正はしません。
&gt; 一応目指すべきはセイバーとラムネのキャラがナデシコ風のノリでエヴァをやるという、わけわからんものです（笑）。『大切なものなんですか？守りたいものなんですか？』っていう秋葉原電脳組のエンディングテーマと、EVAの人類補完計画（これでは全人類救済計画）思いついたって言うのは冗談みたいな事実・・・。
&gt; あほですか・・・ｗ？
&gt; 一応ゲバルト・ファシストとか電子の妖精ロリロリ、NEMGAL（株）の会長さんは次回登場予定です。</textarea><br>
