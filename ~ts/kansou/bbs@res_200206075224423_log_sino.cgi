...
<input type=hidden name="nj" value="dY1hyUknzA">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:ぱられる読みました"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 電波妖精さん
&gt; 第二掲示板でも見てた記憶があるんですけど、もう一度読み直しました。
&gt; 親友どうしがつきあう。いわゆる親友萌えがうまい具合にコンパクトにまとまっていると思いましたよ。うまい♪</textarea><br>
