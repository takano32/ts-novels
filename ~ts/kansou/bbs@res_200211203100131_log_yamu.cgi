...
<input type=hidden name="nj" value="d1TyDCVQGA">
...
&gt; どうもお騒がせしまして申し訳ございません。
&gt; ここだけ化けていたので、もしかしてと思ってしまったのですが、
&gt; 別のPC（深夜しか使えない）で読み込んだところ正常になってました。
&gt; 結果として夜夢様・kou様をはじめとして文庫の皆様に
&gt; ご迷惑をおかけしたことを、この場をお借りしておわびいたします。
&gt; m( )m</textarea><br>
