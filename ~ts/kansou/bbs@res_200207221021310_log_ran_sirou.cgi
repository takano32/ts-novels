...
<input type=hidden name="nj" value="E4chDPJ3gT">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:ここに置くのもったいないですね。"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ 矢治浩平＠サイト管理者さん
&gt; それなりに私財を投じているもんとすれば、「もったいない」とか言われると心中複雑ですし、あなたの言う「まとも」な作品は皆無ではないと思っています。
&gt; 掲載されている作品やサイト内のコメントへの批判は別にかまわないませんが、勝手な想像で読み手のレベルを限定するのは、どうかと思います。</textarea><br>
