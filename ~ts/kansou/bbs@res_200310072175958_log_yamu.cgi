...
<input type=hidden name="nj" value="OE3KNQBSLO">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re:２３号･･････？"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ Zyukaさん
&gt; あれ？　そのナンバーは既に登場されていたようないなかったような･･････
&gt; 
&gt; 気になったもので･･････すいません</textarea><br>
