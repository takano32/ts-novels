...
<input type=hidden name="nj" value="T9AhbdTSfc">
...
内容 ＼ 題名 <input type=text name="subject" size=45 maxlength=80 value="Re2:連絡"><br>
<textarea name="value" rows=5 cols=80 wrap=soft>▼ りょう＠運営委員さん
&gt; ▼ ライターマンさん
&gt; &gt; えっと、メールの宛先が判らないんでここで失礼します。
&gt; 
&gt; この件をあさりさんにメールでお知らせしておきました。
&gt; ですので、しばらくしたらレスが付くかと思います。
&gt; 
&gt; ------------------------------------------
&gt; 
&gt; ……と書き込んだのですが、このすぐ後にメールが届かずに戻ってきているのに気づきました。
&gt; あさりさんがこの掲示板を見ていてくれるといいんですが。</textarea><br>
