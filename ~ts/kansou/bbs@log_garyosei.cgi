...
<input type=hidden name="nj" value="iXrcI3A7f7">
...
削除キー <input type=password name="pwd" size=10 value=""> 入力コード DyMVcW  <input type=text name="rcode" size=10 value=""> <input type=hidden name="hrcode" size=10 value="DyMVcW"> <Script language=vbscript>
<!--
