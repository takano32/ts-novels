...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[302] vogvip.com VOGスーパーコピー 激安" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; Tiffany&amp;Coのネックレスは、芸術的なインスピレーションと洗練された工芸品のようです。自然、文化、芸術から豊かなインスピレーションを得て、ユニークなデザインに変換しています。ネックレスの製作技術は絶妙で、すべての細部が注意深く彫られています。宝石は間違いなくちりばめられ、金属は滑らかに磨かれています。ユニークな色の組み合わせと形のデザインは、多くのネックレスの中で際立っています。身につけると、まるで流れる芸術品のようで、魅力的で高貴な雰囲気が漂います。
&gt; 
&gt; https://www.vogvip.com/brand-28-c0.html</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="captcha@f8fc977399c2c97aacf487b4b632a9c1844b.cgi" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="f8fc977399c2c97aacf487b4b632a9c1844b" />
	</td>
<!-- captcha_end -->
</tr>
</table>
