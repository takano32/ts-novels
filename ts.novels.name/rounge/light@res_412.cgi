...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[412] adult social" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; Through bid writing training provided by the College of Contract Management, learners explore essential bid documents and submission workflows. An advantage emerges in mastering required language and structure of bids in construction contracts. The diploma includes modules and improves readiness for bid management roles. か</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="./captcha.cgi?f3f4937391cfc179acf485b0bb3badcb854f" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="f3f4937391cfc179acf485b0bb3badcb854f" />
	</td>
<!-- captcha_end -->
</tr>
</table>
