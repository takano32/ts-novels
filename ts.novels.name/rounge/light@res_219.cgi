...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[219] filisap tempest 闍ｱ謨ｰ蟄�" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; 繧ｷ繝ｪ繧｢繝ｫ繧ｭ繝ｼ縺ｨ繝｡繝ｼ繝ｫ System Requirements (Windows Vista, 7, 8, 8.1 and 10)
&gt; Processor: 1.6Ghz or equivalent
&gt; RAM: 800MB or equivalent
&gt; Disk space: more than 500MB is recommended to install older drivers
&gt; 
&gt; This app helps you to dim the light used to display your PC&#39;s on your screen. To enable or disable it, on the &#39;Settings&#39; panel, simply choose the &#39;Dim&#39; mode. Simply by pressing the &#39;Windows Key + M&#39; https://ipayif.com/upload/files/2022/06/mL84aa2ReV7PQ4rmNkqV_06_f3fdce3ce6e41a63a6de28a55334ff94_file.pdf
&gt;  50e0806aeb filisap</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="./captcha.cgi?fbfc967390cece7facf482bebb38adc1804e" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="fbfc967390cece7facf482bebb38adc1804e" />
	</td>
<!-- captcha_end -->
</tr>
</table>
