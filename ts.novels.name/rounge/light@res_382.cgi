...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[382] グッチベルト コピー" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; 最高級グッチベルト コピー偽物激安専門店【hacopyss】。 大人気グッチ ベルト人気豊富に揃えております、大人気グッチ ベルト GG 偽物が大集合！！ 信用、品質、対応を 第一に考えております。全部実物撮影しております。無事に到着できるの絶対保障です！品質も2年間保証しています。
&gt; https://hacopyss.com/collections/gucci-bag-1</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="./captcha.cgi?f2fa9d799fc6c87eacf485beb738abc68048" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="f2fa9d799fc6c87eacf485beb738abc68048" />
	</td>
<!-- captcha_end -->
</tr>
</table>
