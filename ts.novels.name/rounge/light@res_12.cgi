...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[12] 協力したい" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; 我々は、この素晴らしい情報を提供することに関与したい。</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="captcha@fdf8977998c5c179acf687bebd3daeca844b.cgi" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="fdf8977998c5c179acf687bebd3daeca844b" />
	</td>
<!-- captcha_end -->
</tr>
</table>
