...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[187] fearnatt pearsson 闍ｱ謨ｰ蟄�" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; 繝代�ｼ繝�繧｣繧ｷ繝ｧ繝ｳ繧｢繧ｷ繧ｹ繧ｿ繝ｳ繝医�励Ο繝輔ぉ繝�繧ｷ繝ｧ繝翫Ν繧ｨ繝�繧｣繧ｷ繝ｧ繝ｳ5.1繧ｯ繝ｩ繝�繧ｯ Key Macro is a macro recorder that works like a video editor. With this tool, you can record several keystrokes in the application and then convert them to macros later.
&gt; This program can be used in combination with other applications. The recorded events can then be activated as needed. For example, if a web page has an embedded Flash animation, you may want to record a sequence of keystrokes and convert them to a Flash program. When it窶冱 time to use the keys, you can play them with the real-time recording function.
&gt; No other recorder can do that.
&gt; Key Macro is a relatively powerful application that is also easy to use. Its interface is intuitive and responsive.
&gt; KEYMACRO Features:
&gt; - Record keystrokes in real-time and convert them to macros later
&gt; - Convert the recorded sequences of keystrokes to a Flash program
&gt; - It can be used in combination with other applications
&gt; - Flexible scripting system
&gt; - Recordings may be stored in various file formats
&gt; - Import saved macros from.dwx files
&gt; - Click and drag selection for the recording
&gt; - Macro editor with visual previews
&gt; - Bottom left label that allows you to edit the position of the recording
&gt; - Context menu at the bottom left of the recording area
&gt; - Status bar
&gt; - Select an area of the screen to record
&gt; - Switch between real-time and batch recording
&gt; - Copy and paste recordings
&gt; - Reverse the order of the recorded keys
&gt; - Paste the recorded keys as a collection of macros
&gt; - Export macros to.dwx files
...
&gt; - Command line tool (Windows only)
&gt; - Support for multi-track recording
...
&gt; - File
&gt; - Save as Flash
&gt; - Export to EXE, MOF, DLL, CFM, CAB
&gt; - Mixing
&gt; - Full screen
&gt; - Undo/redo
&gt; - AudioMixing
&gt; - File
&gt; - Export to EXE, MOF https://wakelet.com/wake/DNGJnuH7pBbRkybG_2lTm
&gt;  70238732e0 fearnatt</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="captcha@fdfa917399c7c879acf482bebb3faec38049.cgi" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="fdfa917399c7c879acf482bebb3faec38049" />
	</td>
<!-- captcha_end -->
</tr>
</table>
