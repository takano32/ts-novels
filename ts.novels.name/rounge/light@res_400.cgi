...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[400] adult social" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; Quality assurance is necessary to maintain high standards in care. The course teaches how to monitor and evaluate service effectiveness. Knowledge of adult social care ensures that improvements are based on accurate assessments. The College of Contract Management equips learners with the tools to manage quality effectively. This leads to consistent and reliable services.
&gt; クリ</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="./captcha.cgi?fffe91739dcec978acf485b0bb3badc7854f" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="fffe91739dcec978acf485b0bb3badc7854f" />
	</td>
<!-- captcha_end -->
</tr>
</table>
