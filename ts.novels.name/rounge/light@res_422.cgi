...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[422] lsm99 login" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; ビジネススタイルと組み合わせれば上品な中にも個性を感じさせ、カジュアルな装いにも意外なほどよ</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="./captcha.cgi?f9fa907c9dc3cf7facf485b0bb3aabcb824a" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="f9fa907c9dc3cf7facf485b0bb3aabcb824a" />
	</td>
<!-- captcha_end -->
</tr>
</table>
