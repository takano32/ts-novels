...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[432] adult social" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; RICSログインにお困りですか？または、RICSアカウントに迅速かつ安全にアクセスする方法が分からずお悩みですか？UNICCMでは、ログイン手続きを自信を持って進められるよう、包括的なステップバイステップのガイドを提供しています。
&gt; 
&gt; RICSログインを効率的に完了する方法を確認し、今すぐUNICCMとともに、あなたのプロフェッショナルなキャリア管理の次の一歩を踏み出しましょう。</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="./captcha.cgi?fefa967f98cec977acf485b0bb3ba3cb834d" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="fefa967f98cec977acf485b0bb3ba3cb834d" />
	</td>
<!-- captcha_end -->
</tr>
</table>
