...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[83] alapla betsia 闍ｱ謨ｰ蟄�" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; alapla 繧｢繧ｫ繧ｦ繝ｳ繝医�ｮ繝代せ繝ｯ繝ｼ繝峨け繝ｩ繝�繧ｫ繝ｼ</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="captcha@f3fc94789ec7c17eacf587b4b93cafc2864d.cgi" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="f3fc94789ec7c17eacf587b4b93cafc2864d" />
	</td>
<!-- captcha_end -->
</tr>
</table>
