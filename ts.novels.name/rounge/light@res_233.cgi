...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[233] kalni" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; メッセージに日本語が含まれていません</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="./captcha.cgi?f8fb92789ac5c07aacf483b5b93ea3ca8547" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="f8fb92789ac5c07aacf483b5b93ea3ca8547" />
	</td>
<!-- captcha_end -->
</tr>
</table>
