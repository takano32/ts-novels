...
<tr>
	...
	<th>タイトル</th>
	<td>
    	<input type="text" name="sub" size="36" value="Re:[319] 無題" />
    	<input type="submit" value="送信する" /><input type="reset" value="リセット" />
  </td>
</tr><tr>
	<th colspan="2">
    	メッセージ<br />
    	<textarea name="comment" cols="60" rows="7">&gt; 私はこの情報が多くの知識であると考えています。</textarea>
	</th>
</tr><tr>
	<th>参照先</th>
...
<!-- captcha_begin -->
	...
	<td class="small">
		...
		（右画像の数字を入力） <img src="captcha@f3f9977b9bc3c177acf487b1bd3ea3c08546.cgi" class="capt" alt="投稿キー" />
		<input type="hidden" name="str_crypt" value="f3f9977b9bc3c177acf487b1bd3ea3c08546" />
	</td>
<!-- captcha_end -->
</tr>
</table>
