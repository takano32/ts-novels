...
<TD><A HREF="../main.html"><STRONG>少年少女ギャラリー ( Gallery Shounen-Shoujo )</STRONG></A></TD>
</TR></TBODY></TABLE>
...
<TD><INPUT CLASS=button TYPE="button" VALUE="使い方(How to Use)" onClick="location='albumbbs@mode_guide.cgi'" onKeyPress="location='albumbbs@mode_guide.cgi'"></TD>
<TD><INPUT CLASS=button TYPE="button" VALUE="リロード(Reload)" onClick="location='albumbbs.cgi'" onKeyPress="location='albumbbs.cgi'"></TD>
<TD><INPUT CLASS=button TYPE="button" VALUE=" 戻る (Return)" onClick="parent.location='../index.html'" onKeyPress="parent.location='../index.html'"></TD></TR>
...
　<SPAN STYLE="font-size:10pt"><INPUT CLASS=button TYPE="button" VALUE="[Reload]" onClick="location='albumbbs.cgi'" onKeyPress="location='albumbbs.cgi'"></SPAN></TD></TR>
