...
.main { color:navy;font-size:10pt }
.reply { color:brown;font-size:10pt }
-->
</STYLE>
</HEAD>
<BODY>
...
<TBODY><TR><TD><A HREF="#post"><STRONG>投稿する</STRONG> (Post)</A></TD>
<TD><A HREF="#album"><STRONG>投稿 を見る</STRONG> (View)</A></TD>
<TD><A HREF="http://www14.big.or.jp/~yays/gallery/main.html"><STRONG>少年少女ギャラリー ( Gallery Shounen-Shoujo )</STRONG></A></TD>
</TR></TBODY></TABLE>
<DIV STYLE="background-color:#E0FFFF;color:#008080;font-size:18pt;;font-weight:bold;width:400">
<A NAME="top">-- 返信機能付きアップロードBBS --</A></DIV>
<H1 STYLE="color:#006400;font-size:28pt">ギャラリー少年少女 (TG Illustrations and Captions)</H1>
</DIV>
<DIV STYLE="text-align:center">
<TABLE summary="notice"><TBODY>
<TR><TD STYLE="color:#C71585;font-size:10pt;font-weight:bold;text-align:center">
♪ 小さな画像をクリックする度に別ウィンドウで原画が表示されます ♪<BR>  *  Click thumbnails to view original images  *</TD></TR>
</TBODY></TABLE><BR>
...
<TD><INPUT CLASS=button TYPE="button" VALUE="使い方(How to Use)" onClick="location='http://www14.big.or.jp/~yays/gallery/album/albumbbs.cgi?mode=guide'" onKeyPress="location='http://www14.big.or.jp/~yays/gallery/album/albumbbs.cgi?mode=guide'"></TD>
<TD><INPUT CLASS=button TYPE="button" VALUE="リロード(Reload)" onClick="location='http://www14.big.or.jp/~yays/gallery/album/albumbbs.cgi'" onKeyPress="location='http://www14.big.or.jp/~yays/gallery/album/albumbbs.cgi'"></TD>
<TD><INPUT CLASS=button TYPE="button" VALUE=" 戻る (Return)" onClick="parent.location='http://www14.big.or.jp/~yays/gallery/'" onKeyPress="parent.location='http://www14.big.or.jp/~yays/gallery/'"></TD></TR>
<TR VALIGN="top"><TD COLSPAN=3 STYLE="color:red;font-size:8pt">　　　[必ずお読みください]<BR> Please read before posting</TD>
</TR></TBODY></TABLE></FORM>
...
(<SPAN STYLE="color:#FF0000">*</SPAN>) <A NAME="post">が付いている項目は必ず記入してください。  Box marked with (*) must be filled.</A>
</DIV>
...
<STRONG>画像ファイル</STRONG>(Image File) </TD>
...
<SPAN STYLE="color:#FFFFFF;font-size:10pt;font-weight:bold"> 画像を選んでください</SPAN>(Select the Target File)</TD></TR>
<TR><TD CLASS=main WIDTH=150><SPAN STYLE="color:red;font-size:8pt">半角英数字 6-8 文字</SPAN><BR>
...
<TD CLASS=main WIDTH=100><STRONG>画像の題名</STRONG>(Image Title) </TD>
<TD CLASS=main COLSPAN=2 WIDTH=200><INPUT CLASS=text TYPE="text" NAME="caption" VALUE="" SIZE=23></TD></TR>

<TR><TD CLASS=main WIDTH=150><STRONG>お名前</STRONG>(Name) (<SPAN STYLE="color:#FF0000">*</SPAN>)</TD>
...
<SPAN STYLE="font-size:8pt">パス、お名前、メール、URLを保存</SPAN>(Use Cookie)</TD></TR>
<TR><TD CLASS=main  WIDTH=150><STRONG>メール</STRONG>(E-mail) </TD>
...
<SPAN STYLE="font-size:8pt">クッキーを削除</SPAN>(Delete Cookie)
<SPAN STYLE="color:mediumvioletred;font-size:8pt"> （送信直後に実行）</SPAN></TD></TR>
...
<TR><TD CLASS=main WIDTH=150><STRONG>タイトル</STRONG>(Subject) </TD>
...
<TR><TD COLSPAN=4 CLASS=main WIDTH=95% ALIGN="center"><STRONG>メッセージ</STRONG>(Message) (<SPAN STYLE="color:#FF0000">*</SPAN>)<BR><BR>
...
<A NAME="album">各ページ</A>には親記事数で<SPAN STYLE="color:red">7</SPAN>件ずつ表示されています。
記録できる記事の総数は親子合計で<SPAN STYLE="color:red">300</SPAN>件です。<BR>
...
<INPUT CLASS=button TYPE="submit" VALUE="記事追加(Reply)">
</TD></TR>
...
<DIV STYLE="text-align:center">
<DIV STYLE="color:#800080;width:100%">
各ページには親記事数で<SPAN STYLE="color:red">7</SPAN>件ずつ表示されています。
記録できる記事の総数は親子合計で<SPAN STYLE="color:red">300</SPAN>件です。<BR>
The recent <SPAN STYLE="color:red">300</SPAN> posts are recorded.
</DIV><BR>
</DIV>
...
-- <a href="http://www2j.biglobe.ne.jp/~apollo/" TARGET="_blank">Album BBS v1.03 rp</A> --
</DIV>
</BODY>
</HTML>
