...
<H3>JavaScriptが有効でないため正常に動作致しません</H3></NOSCRIPT>
	...
	[<a TITLE="投稿順に表示" href="bbsnote@fc_page_sort_0_page_2.cgi">投稿順</A>]
	[<a TITLE="サムネイル軽量表示" href="bbsnote@fc_page_mode_light_sort_1_page_2.cgi">サムネイル</A>]
<!--SKIN_WRITE:begin-->	[<a TITLE="通常書き込み" href="bbsnote@fc_post.cgi">通常カキコ</a>]<!--SKIN_WRITE:end-->
	...
	[<A TITLE="削除モードへ" HREF="bbsnote@fc_delete_sort_1_page_2.cgi">消す</A>]
