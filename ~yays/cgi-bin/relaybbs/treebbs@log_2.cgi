...
href="treebbs@new_1.cgi">新規発言</a> ｜ <a
href="treebbs.cgi">一覧</a> ｜ <a
href="treebbs@newlogs_1.cgi">最新記事</a> ｜ <a

href="treebbs@seek___setu_1.cgi">検索</a> ｜ <a
href="../../../~ezpe/yasai/archives.html">ＨＯＭＥ</a>
</center><hr size=1>

<table width="100%">
 <tr>
  <td bgcolor="#E0E0E0">
   <b><font size=4>No.2　 伝説の剣</font></b>
  </td>
 </tr>
</table>
...
発言者：<b> 犬瓦ハム太</b></a><br>
発言日：<b> 2001 12/08 16:15</b>
<blockquote>
しかし！<br>
海水に長年浸かっていた剣はボロボロで使い物になりませんでした。
</blockquote>
...
>│<br
>└<a href="treebbs@all_1_s_1.cgi">◆</a>1:<a href="treebbs@log_1.cgi">これはテストですです</a> [犬瓦ハム太] 12/08 16:14<br
>　└<a href="treebbs@all_1_s_2.cgi">◆</a>2:<b>伝説の剣</b> [犬瓦ハム太] 12/08 16:15<b><font color="#888888">&lt;-last</font></b></pre><hr size=1><table>
 <tr>
  <td>
  <form action="treebbs.cgi" method=POST>
  <input type=hidden name=ha value=ha><a name=re>　 返信フォーム</a>　<tt>[<a href='treebbs@log_2_hens_1.cgi'>引用</a>]</tt>
  <table>
   ...
   <tr>
    <td bgcolor="#E0E0E0">題　名</td><td><input type=text size=40 name=dai value='Re:伝説の剣'></td>
   </tr>
   <tr>
    <td bgcolor="#E0E0E0">メール</td><td><input type=text size=30 name=email VCARD_NAME="vCard.Email" ><tt>省略可</tt></td>
   </tr>
   <tr>
    <td valign=top bgcolor="#E0E0E0">発　言</td><td><textarea name=t rows=10 cols=60></textarea></td>
   </tr>
   <tr>
...
◇ひとつのツリーに投稿できる記事は最大60件までと決まっています。<br>
◇最大20階層までしか発言できません。<br>
◇ツリー記事数や階層の深さ制限にひっかかったときは、続編となるツリーを新たに立ててください。<br>
◇管理人の判断によりやむを得ず投稿は削除させていただく場合があります。<br>
</tt>
