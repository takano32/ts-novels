...
<input type=text size=48 name=subject value=RE:すずめのみや様、ＡＬＯ様、ありがとうございます。>
</td></tr>
...
<input type=hidden name=ress value=1817>
<input type=submit value=すずめのみや様、ＡＬＯ様、ありがとうございます。へ返信>
...
<dl>
<input type=checkbox name=delcode value=1817>
