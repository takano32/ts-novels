...
<input type=hidden name=idnum value=47510><BR>
<img SRC="out.png?31647510"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2775>
...
<dl>
<input type=checkbox name=delcode value=2775>
...
<ul><br><font size=3>ウェブ検索ではなくてカテゴリ検索の方に乗らないと、yahooに登録されたことにはならないと思います～<br><a href=http://dir.yahoo.co.jp/Society_and_Culture/Food_and_Drink/Types_of_Foods/Noodles/Soba/Tachigui/ target=_top>http://dir.yahoo.co.jp/Society_and_Culture/Food_and_Drink/Types_of_Foods/Noodles/Soba/Tachigui/</a><br></font></ul>
<HR>
</dl>
</td></tr></table><br>
