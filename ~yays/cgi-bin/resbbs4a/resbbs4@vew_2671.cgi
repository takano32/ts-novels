...
<input type=text size=48 name=subject value=RE:開かない>
</td></tr>
<tr><td align=right>HP:</td><td><input type=text size=48 name=HP value=></td>
</tr></table>
<textarea name=comment rows=4 cols=70></textarea><br>
<input type=hidden name=idnum value=8472><BR>
<img SRC="out.png?3168472"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=mother value=2670>
<input type=hidden name=ress value=2671>
<input type=submit value=開かないへ返信>
...
<dl>
<input type=checkbox name=delcode value=2671>
...
<ul><br><font size=3>鯖が落ちたんですかねぇ。</font></ul>
<HR>
