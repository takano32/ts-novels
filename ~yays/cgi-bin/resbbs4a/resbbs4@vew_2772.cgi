...
<input type=hidden name=idnum value=53780><BR>
<img SRC="out.png?31653780"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2772>
...
<ul><br><font size=3>いま慌ててYahooを確認してきたのですが、探し方が悪かったのか、残念ながら見つかりませんでした。<br>うーん、探す場所を間違ったのかもしれません。</font></ul>
<HR>
</dl>
</td></tr></table><br>
