...
<input type=text size=48 name=subject value=RE:Arigato,　minna-san>
</td></tr>
...
<input type=hidden name=ress value=1272>
<input type=submit value=Arigato,　minna-sanへ返信>
...
<dl>
<input type=checkbox name=delcode value=1272>
