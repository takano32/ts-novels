...
<input type=hidden name=ress value=1451>
...
<dl>
<input type=checkbox name=delcode value=1451>
...
<ul><br><font size=3>カシオなのでファイバマン・・・ありそう。<br><br>うちの電源入れっぱなマシンは超静音ながらK6-3/400な自作マシンなんで、キャプチャには力不足。<br>当分はふつーのビデオデッキが手放せません。いいなぁＨＤＤ保存。<br></font></ul>
<HR>
