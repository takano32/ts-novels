...
<input type=hidden name=idnum value=58264><BR>
<img SRC="out.png?31658264"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2760>
...
<dl>
<input type=checkbox name=delcode value=2760>
...
<ul><br><font size=3>　既に手動で管理できるほど、スパム投稿は甘いものではなくなっています。<br>　何らかのスパム対策が可能となるまで、一端閉鎖されてはいかがでしょうか。</font></ul>
<HR>
</dl>
</td></tr></table><br>
