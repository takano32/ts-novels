...
<input type=text size=48 name=subject value=RE:補足>
</td></tr>
<tr><td align=right>HP:</td><td><input type=text size=48 name=HP value=></td>
</tr></table>
<textarea name=comment rows=4 cols=70></textarea><br>
<input type=hidden name=idnum value=52920><BR>
<img SRC="out.png?31652920"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2815>
<input type=submit value=補足へ返信>
...
<dl>
<input type=checkbox name=delcode value=2815>
...
<a href="resbbs4.cgi?vew=2815">[返信]</a><br>
　<font size=-1 color=#A08050>【いま気になる小説は、<b></b>】</font>
</td></tr><tr><td>
<ul><br><font size=3>　アドレスが途中で切れてしまったので、とりあえずHome用のアドレス入力欄に該当ページのアドレスを入れておきます。連投失礼。</font></ul>
<HR>
</dl>
</td></tr></table><br>
