...
<input type=hidden name=idnum value=58031><BR>
<img SRC="out.png?31658031"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2698>
...
<dl>
<input type=checkbox name=delcode value=2698>
...
<ul><br><font size=3>あ、理事長！<br>更新希望です</font></ul>
<HR>
</dl>
</td></tr></table><br>
