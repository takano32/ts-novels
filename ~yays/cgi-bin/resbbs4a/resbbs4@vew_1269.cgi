...
<input type=hidden name=ress value=1269>
...
<dl>
<input type=checkbox name=delcode value=1269>
...
<ul><br><font size=3>There are no native English speaker, therefore responsive should be slow.  So few day or week.<br>Please wait a long stay.<br>(I wrote this message at the cost of half-hour & dictionaly)<br></font></ul>
<HR>
