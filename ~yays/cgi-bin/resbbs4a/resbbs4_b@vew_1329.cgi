...
<input type=hidden name=ress value=1329>
...
<dl>
<input type=checkbox name=delcode value=1329>
...
<ul><br><font size=3>うはー使えた。悪用しちゃいやん。<br>でもお絵描き板のイラストに長いテキストを添えたいときは応用できそう。</font></ul>
<HR>
</dl>
</td></tr></table><br>
