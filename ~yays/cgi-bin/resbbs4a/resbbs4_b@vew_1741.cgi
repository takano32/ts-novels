...
<input type=hidden name=ress value=1741>
...
<dl>
<input type=checkbox name=delcode value=1741>
...
<ul><br><font size=3>訂正<br><br>jbbs.shitaraba.com/comic　　　100　　　yays_感想掲示板<br><br>追加する行は、これが正解です。<br>ただし、スペースの代わりに区切り位置にTABを入れてください。<br>（掲示板上ではTABが表示されないため、スペースで代用してます）</font></ul>
<HR>
</dl>
</td></tr></table><br>
