...
<input type=text size=48 name=subject value=RE:マジ？>
</td></tr>
...
<input type=hidden name=ress value=2113>
<input type=submit value=マジ？へ返信>
...
<dl>
<input type=checkbox name=delcode value=2113>
...
<ul><br><font size=3>先程のカキコ「マジ？」と題名に書こうとしたら、<br>HPのとこへ間違って「マジ？」とカキコしてしまい、<br>表示がバグってしまいました。<br></font></ul>
<HR>
