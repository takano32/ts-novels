...
<input type=hidden name=idnum value=79055><BR>
<img SRC="out.png?31679055"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2771>
...
<dl>
<input type=checkbox name=delcode value=2771>
...
<ul><br><font size=3>なななんとマジですか！？</font></ul>
<HR>
</dl>
</td></tr></table><br>
