...
<input type=hidden name=ress value=1653>
...
<dl>
<input type=checkbox name=delcode value=1653>
...
<ul><br><font size=3>おっと、入れ違いのレスでした。<br>フォローありがとうございます。<br>とりあえず、管理人として一律禁止をすることはないです。<br>メリットとデメリットの双方があることだと思いますので、個々人ごと・ケースごとに是非の判断をしてもらいたいと思います。</font></ul>
<HR>
</dl>
</td></tr></table><br>
