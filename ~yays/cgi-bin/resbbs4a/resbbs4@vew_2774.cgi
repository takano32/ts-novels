...
<input type=text size=48 name=subject value=RE:情報板に書くのはあれなんで>
</td></tr>
<tr><td align=right>HP:</td><td><input type=text size=48 name=HP value=></td>
</tr></table>
<textarea name=comment rows=4 cols=70></textarea><br>
<input type=hidden name=idnum value=74594><BR>
<img SRC="out.png?31674594"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=mother value=2774>
<input type=hidden name=ress value=2774>
<input type=submit value=情報板に書くのはあれなんでへ返信>
