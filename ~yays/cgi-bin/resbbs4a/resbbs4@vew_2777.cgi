...
<input type=hidden name=idnum value=24815><BR>
<img SRC="out.png?31624815"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2777>
...
<ul><br><font size=3>話は脱線するのですが、ウィキと言えば最近ウィキペディアに「TSF」という項目が出来ましたがまだまだ中身を充実させる余地がありそうです。<br><br><a href=http://ja.wikipedia.org/wiki/TSF target=_top>http://ja.wikipedia.org/wiki/TSF</a></font></ul>
<HR>
</dl>
</td></tr></table><br>
