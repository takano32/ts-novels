...
<input type=hidden name=idnum value=108844><BR>
<img SRC="out.png?315108844"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2697>
...
<dl>
<input type=checkbox name=delcode value=2697>
...
<ul><br><font size=3>ここっす<br><a href=http://ts-f.net/~tsu/ target=_top>http://ts-f.net/~tsu/</a><br>ちなみにもう２年以上中身の更新していません</font></ul>
<HR>
