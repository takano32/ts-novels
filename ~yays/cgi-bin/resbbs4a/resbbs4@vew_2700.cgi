...
<input type=hidden name=idnum value=27538><BR>
<img SRC="out.png?31527538"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2700>
...
<ul><br><font size=3>ありがとうございます</font></ul>
<HR>
</dl>
</td></tr></table><br>
