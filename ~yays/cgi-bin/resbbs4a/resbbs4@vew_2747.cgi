...
<input type=hidden name=idnum value=32170><BR>
<img SRC="out.png?31632170"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2747>
...
<dl>
<input type=checkbox name=delcode value=2747>
...
<ul><br><font size=3>テスト投稿ぐらいならOKになったと思います。<br>ブラウザにキャッシュを使わせない処理がうまくいってないのでリロードしないと4桁の数字合わせが失敗することがあります。<br>その他、返信で失敗したあとの再投稿リンクが間違ってるなど問題多数。</font></ul>
<HR>
