...
<input type=hidden name=idnum value=61595><BR>
<img SRC="out.png?31661595"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2776>
...
<ul><br><font size=3>そうなんだ。早合点すみませんでした</font></ul>
<HR>
</dl>
</td></tr></table><br>
