...
<input type=hidden name=ress value=2029>
...
<dl>
<input type=checkbox name=delcode value=2029>
...
<ul><br><font size=3>返事ありがとうございます.  <br>そして他のものはないでしょうか?...ここに書いてくれたことは大部分読んで見ました.(^.^)</font></ul>
<HR>
