...
<input type=text size=48 name=subject value=RE:テスト>
</td></tr>
...
<input type=hidden name=ress value=1328>
<input type=submit value=テストへ返信>
...
<ul><br><font size=3><img SRC="../../nuts_s.jpg"><br>IMGタグって使えたっけ？テスト</font></ul>
<HR>
