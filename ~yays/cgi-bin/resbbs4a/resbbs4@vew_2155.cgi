...
<input type=hidden name=ress value=2155>
...
<dl>
<input type=checkbox name=delcode value=2155>
...
<ul><br><font size=3>うち(ts-f.net)のメールアカウントで良ければ作りますよ。<br>もし必要ならts-f.netのwebmastarにメール下さい。</font></ul>
<HR>
