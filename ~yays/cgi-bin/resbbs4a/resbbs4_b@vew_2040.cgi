...
<input type=hidden name=ress value=2040>
...
<dl>
<input type=checkbox name=delcode value=2040>
...
<ul><br><font size=3>お気持ちはわかりますが、こういうのは確信犯的にやってますから<br>文句を言っても無駄ですよ。<br>削除されるまで完全に無視するのが一番です。</font></ul>
<HR>
</dl>
</td></tr></table><br>
