...
<input type=hidden name=idnum value=104443><BR>
<img SRC="out.png?316104443"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2768>
...
<dl>
<input type=checkbox name=delcode value=2768>
