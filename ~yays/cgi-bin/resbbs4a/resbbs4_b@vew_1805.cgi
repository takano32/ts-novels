...
<input type=text size=48 name=subject value=RE:あるお方から見れないとの苦情がありまして・・・>
</td></tr>
...
<input type=hidden name=ress value=1805>
<input type=submit value=あるお方から見れないとの苦情がありまして・・・へ返信>
