...
<input type=hidden name=idnum value=58168><BR>
<img SRC="out.png?31658168"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2742>
...
<dl>
<input type=checkbox name=delcode value=2742>
...
<ul><br><font size=3>書き込めないかテストテスト</font></ul>
<HR>
