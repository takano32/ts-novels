...
<input type=text size=48 name=subject value=RE:化学（ばけがく）戦隊>
</td></tr>
...
<input type=hidden name=ress value=1448>
<input type=submit value=化学（ばけがく）戦隊へ返信>
...
<ul><br><font size=3>ダイナマンはおいらでしゅ。<br><br>ちょっと最近は持ち歩く機会がないので、<br>愚弟の将棋マシンと化しております。<br></font></ul>
<HR>
</dl>
</td></tr></table><br>
