...
<input type=text size=48 name=subject value=RE:姉汁>
</td></tr>
<tr><td align=right>HP:</td><td><input type=text size=48 name=HP value=></td>
</tr></table>
<textarea name=comment rows=4 cols=70></textarea><br>
<input type=hidden name=idnum value=84668><BR>
<img SRC="out.png?31684668"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=mother value=2678>
<input type=hidden name=ress value=2678>
<input type=submit value=姉汁へ返信>
