...
<input type=hidden name=ress value=1590>
...
<dl>
<input type=checkbox name=delcode value=1590>
...
<ul><br><font size=3>私の場合は、普通に恋をして、普通に結婚をして、<br>今、４歳の娘を持つ父親です。<br>でも、それと趣味とは関係ありません。<br>放っておいて貰いましょう。<br>（このコメントごとの消去もＯＫです）</font></ul>
<HR>
