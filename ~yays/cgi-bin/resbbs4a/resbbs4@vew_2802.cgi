...
<input type=hidden name=idnum value=107961><BR>
<img SRC="out.png?316107961"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2802>
...
<dl>
<input type=checkbox name=delcode value=2802>
...
<ul><br><font size=3>普通に、Ｗ○ｎ○ｙでありました</font></ul>
<HR>
</dl>
</td></tr></table><br>
