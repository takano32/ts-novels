...
<input type=hidden name=idnum value=107894><BR>
<img SRC="out.png?218107894"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=mother value=>
<input type=hidden name=ress value=>
