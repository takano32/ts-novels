...
<input type=hidden name=idnum value=1199><BR>
<img SRC="out.png?3161199"> 左の4桁の数字を半角数字で入力してください: <input type="text" size=8 name="captcha"><br> <br>
いま気になる
...
<input type=hidden name=ress value=2773>
...
<ul><br><font size=3>すいません。お手数かけてm(__)m yahooでyaysで検索かけたら一番上にありましたよ直接のアドレスも張っておきますね <a href=http://search.yahoo.co.jp/search target=_top>http://search.yahoo.co.jp/search</a>?p=yays&fr=top_v2&tid=top_v2&search.x=1</font></ul>
<HR>
